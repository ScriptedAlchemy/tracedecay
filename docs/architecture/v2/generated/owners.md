...
| workflow-compiler-engine | Root Private Module | `src/v2/workflow_compiler_engine` | 5 | `private` | `docs/plans/tracedecay-v2/32-dynamic-workflow-runtime-and-sdk.md` |
