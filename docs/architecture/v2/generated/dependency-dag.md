...
flowchart TD
  ...
  workflow_compiler_engine["workflow-compiler-engine"] --> domain["domain"]
  workflow_compiler_engine["workflow-compiler-engine"] --> workflow["workflow"]
  workflow_compiler_engine["workflow-compiler-engine"] --> application["application"]
  ...
  root["root"] --> workflow_compiler_engine["workflow-compiler-engine"]
