...
**Phase/order split:** PR 14A remains Phase 2 because it is release-excluded evaluation over frozen synthetic code-document fixtures after PR 2A. Production semantic work is Phase 3 and follows `PR 6C + PR 18D + accepted PR 14A -> PR 14E -> PR 14B -> PR 14C`. A disabled PR 14A disposition terminalizes 14E/14B/14C as skipped; it never blocks lexical retrieval or later nonsemantic Phase-2 query work.
