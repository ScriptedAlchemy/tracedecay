...
- candidate created/validated/activated/rejected; decomposition atomicity; offer revocation after dependency/head change; expansion-boundary/reclaim readiness decisions; terminal-negative-review successor and duplicate-derivation suppression;
