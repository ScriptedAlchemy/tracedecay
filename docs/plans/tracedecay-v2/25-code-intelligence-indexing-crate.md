...
- [ ] Add `build_operation_identity_binds_exact_shard_generation_overlay_and_epoch` and `checkpoint_and_manifest_publication_precede_clean_terminal_receipt`; no repository-wide/branch-name marker can satisfy either test.
