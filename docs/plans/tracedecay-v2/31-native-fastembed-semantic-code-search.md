...
This plan creates no slice and is supporting research/design evidence, not execution authority. The canonical PR blocks in plans 02/05/12/13/15/20/25 and the master plan own the obligations summarized below; their machine-readable block digests are the stale-work boundary. Implementers execute those canonical blocks and use this plan only for the linked rationale, benchmark protocol, and upstream evidence.
