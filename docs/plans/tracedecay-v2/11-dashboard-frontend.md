...
| Main-thread long task | none `> 50 ms` (PerformanceObserver `longtask` entries) during the fourteen scripted section 22.2 tasks, which define the primary workflows |
