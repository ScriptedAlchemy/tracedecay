...
- PR 14A is the only semantic-search slice permitted in Phase 2: release-excluded evaluation over frozen synthetic code-document fixtures after PR 2A. Production order is Phase 3: `PR 6C + PR 18D + accepted PR 14A -> PR 14E -> PR 14B -> PR 14C`; disabled 14A terminalizes those production-only descendants as skipped.
