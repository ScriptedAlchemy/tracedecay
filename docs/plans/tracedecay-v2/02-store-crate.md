...
and [global ownership rules](README.md). [PR20](33-end-to-end-performance-optimization.md)
owns the versioned database and write-amplification workloads, comparable
