...
- Added a contemporary capability/performance comparison; the document was
  later removed when final V2 replaced its storage and branch assumptions.
