...
## [0.1.0](https://github.com/ScriptedAlchemy/tracedecay/compare/v0.0.74...v0.1.0) (2026-08-28)


### Features

* **code-index:** persist worker-count intent ([fc92c2f](https://github.com/ScriptedAlchemy/tracedecay/commit/fc92c2f9d0b772efb49c7ebfcc961ea0aaf3b4db))
* **config:** persist profile worker selection ([ed7dc92](https://github.com/ScriptedAlchemy/tracedecay/commit/ed7dc925932966251ab8619a8f6fd76c36fb19a6))
* consolidate TraceDecay V2 PR8-PR13 delivery ([89f7c84](https://github.com/ScriptedAlchemy/tracedecay/commit/89f7c84eaa9d686185906c8c8d8518b124bb9c18))
* **dashboard:** manage profile worker selection ([a404fde](https://github.com/ScriptedAlchemy/tracedecay/commit/a404fde22b22d44973062a1c62db10443f3cd6bd))
...
* **runtime-core:** publish writer telemetry snapshot ([7cc28d9](https://github.com/ScriptedAlchemy/tracedecay/commit/7cc28d96aa862c3a3403c1acce3d75437f7e79d6))
* **scripts:** sample OS-counter deltas for hotpath runs ([0fc8986](https://github.com/ScriptedAlchemy/tracedecay/commit/0fc89864bf01411afb51baf612950e1cd09dbe1d))
* **sessions:** batch observation capture through persist_observations ([017ec22](https://github.com/ScriptedAlchemy/tracedecay/commit/017ec223d97ef18409b4b84c9dfaf9b63a4f1702))
* **store:** persist observation batches in one writer txn ([ea645ad](https://github.com/ScriptedAlchemy/tracedecay/commit/ea645ad808f69241b25fadf5d7349c24e7d76921))


### Bug Fixes

* **agent-hosts:** import Copilot test error type ([71ccb7e](https://github.com/ScriptedAlchemy/tracedecay/commit/71ccb7ec65f84d8e88790028e9e6dcac2d3aa633))
* **api:** box the oversized HTTP admission rejection ([15f3893](https://github.com/ScriptedAlchemy/tracedecay/commit/15f3893a6ac9faa5d209e2848bf76f9a2a625661))
* **application:** box the runtime on the after-runtime finish path ([30af595](https://github.com/ScriptedAlchemy/tracedecay/commit/30af59578e301fd9be0e062b088b5d8de7077e89))
* **application:** drop the orphaned admitted_progress reader ([3188c42](https://github.com/ScriptedAlchemy/tracedecay/commit/3188c420555786eb376ae9628911ca3a5e7e779d))
* **application:** match retained surface ports instead of ok_or ([fd85e24](https://github.com/ScriptedAlchemy/tracedecay/commit/fd85e24fc9ac5ac94adc6f0092c82557a1cfd52b))
* **application:** name the feedback read port future ([3d979ee](https://github.com/ScriptedAlchemy/tracedecay/commit/3d979eed5eda820d4e4a9e4b7f26e4f421a707d0))
* **application:** surface replay attempt cleanup failures ([d5a0059](https://github.com/ScriptedAlchemy/tracedecay/commit/d5a0059da330e04eb1832eb17bdae6ccaad9b8d9))
* **application:** type the exact-query clock failure ([c287aad](https://github.com/ScriptedAlchemy/tracedecay/commit/c287aadb3e5c2dbbb4c25a6cbec8b6de58cf4165))
* **application:** typed clock failure and catalog pagination errors ([1fd7847](https://github.com/ScriptedAlchemy/tracedecay/commit/1fd784768bb373e89db2559db6b14526a997fa71))
* **application:** use slice contains for review link dedupe ([d3d8f56](https://github.com/ScriptedAlchemy/tracedecay/commit/d3d8f5600be6438ef0c1a744d35c0473be0ea1ba))
* **automation:** keep a vanished job lock contended instead of stale ([316c121](https://github.com/ScriptedAlchemy/tracedecay/commit/316c121cf56a31a059694243070cded980e541df))
* **automation:** keep a vanished job lock contended instead of stale ([b44015f](https://github.com/ScriptedAlchemy/tracedecay/commit/b44015fa02571d93938aa764c0a81102615131ce))
* **automation:** key backend suppress on opened-file identity ([d48d05c](https://github.com/ScriptedAlchemy/tracedecay/commit/d48d05cb4fd252bec3d538c9e49f64ba4e06f701))
* **automation:** persist backend suppression identity ([afdf659](https://github.com/ScriptedAlchemy/tracedecay/commit/afdf659341ede4559111665c6405db32b5256039))
* **automation:** restore skill receipt digest authority ([b8ea46c](https://github.com/ScriptedAlchemy/tracedecay/commit/b8ea46cec05cc9ddb0d5370f01b954d35374e384))
* **benchmarks:** restore non-path replacements ([437e097](https://github.com/ScriptedAlchemy/tracedecay/commit/437e097ca261eb729154aa333d91faedcd1388e7))
* **build:** restore APIs the extraction merges made private ([399b84f](https://github.com/ScriptedAlchemy/tracedecay/commit/399b84fa3c8bf9eb4fec0f2b1041a1fcf9edd5fd))
* **capture:** take opencode timestamp predicate by reference ([3a2bf5d](https://github.com/ScriptedAlchemy/tracedecay/commit/3a2bf5de1f505581849db6db61aab36e4d6cc52e))
* **checkpoint:** honor configured WAL budget ([61b1206](https://github.com/ScriptedAlchemy/tracedecay/commit/61b12065b7b7b3619832ed16561e872667bf191d))
* **ci:** clear clippy findings on writer and maintenance ([b7e28f9](https://github.com/ScriptedAlchemy/tracedecay/commit/b7e28f90692e9a9045ba0bfe1869eb53ec9fdb06))
* **ci:** clear the blocking clippy policy findings ([e97c35a](https://github.com/ScriptedAlchemy/tracedecay/commit/e97c35a1859ce5c912175f8b9b8d81b43b87c676))
* **ci:** clear the next layer of clippy policy findings ([5fb2684](https://github.com/ScriptedAlchemy/tracedecay/commit/5fb2684b021db542e6172abd2a79b092044c18b5))
* **ci:** cli-non-interactive-test-sta ([95c66ee](https://github.com/ScriptedAlchemy/tracedecay/commit/95c66eefc73acf4c87d93642e5fb8d20044727d1))
* **ci:** collapse extractor ifs and gate test-only helpers ([673c218](https://github.com/ScriptedAlchemy/tracedecay/commit/673c21851c839fef91e7a0a805a0889758561353))
* **ci:** doctor-tests-current-project ([d937d93](https://github.com/ScriptedAlchemy/tracedecay/commit/d937d9355205ccae553eb7702d17c4d614a3e744))
* **ci:** drop the uncalled uncached relation-locator loader ([a050971](https://github.com/ScriptedAlchemy/tracedecay/commit/a05097124737a8dc13104f8d69686520a111eaee))
* **ci:** drop unused imports in the mcp and storage suites ([6a73911](https://github.com/ScriptedAlchemy/tracedecay/commit/6a739117f43c0aa526038f99f5d211aeeb548e99))
* **ci:** finish workspace lint cleanup ([8dd04dd](https://github.com/ScriptedAlchemy/tracedecay/commit/8dd04dd246eb84bc7719bef519b0ca3917cd0ee2))
* **ci:** gate test-only daemon helpers and clear lint findings ([6b20aac](https://github.com/ScriptedAlchemy/tracedecay/commit/6b20aacd2a86d3cc3c71ddabc606f8cf9af97753))
* **ci:** graph-db-edge ([c1762e6](https://github.com/ScriptedAlchemy/tracedecay/commit/c1762e68663d945850e32bb1dabc57e9c6267e5b))
* **ci:** graph-db-locator ([0fe72ca](https://github.com/ScriptedAlchemy/tracedecay/commit/0fe72caf17f2557ce73f8fb12022a27ad97a83d9))
* **ci:** integrate graph state repairs ([9e9e4fe](https://github.com/ScriptedAlchemy/tracedecay/commit/9e9e4fec90f9e9784119576af276cd148e9659a4))
* **ci:** integrate registered status repair ([58b6605](https://github.com/ScriptedAlchemy/tracedecay/commit/58b66058ddbaebc377bd578ccb25990f68d8d02a))
* **ci:** integrate shared PR 663 repairs ([db177fb](https://github.com/ScriptedAlchemy/tracedecay/commit/db177fb746fbffb9b3a9752461f61f4ad2e36f72))
* **ci:** merge generated SDK repairs ([f0a2fe8](https://github.com/ScriptedAlchemy/tracedecay/commit/f0a2fe8361b13b62855d5a1a55abed4426c25a43))
* **ci:** move LCM retrieval index and map session source coverage ([add8322](https://github.com/ScriptedAlchemy/tracedecay/commit/add8322b292152f4411984bf38557b96929e25ef))
* **ci:** refresh lockfile after dropping hotpath futures ([a8b3db4](https://github.com/ScriptedAlchemy/tracedecay/commit/a8b3db4ed0812e6ee14471978d585b63556be311))
* **ci:** restore session-sync waits and MCP token accounting ([8ff67f5](https://github.com/ScriptedAlchemy/tracedecay/commit/8ff67f567be5779ec3af84f0a56e1ded94d1251c))
* **ci:** retained-owner-lcm-rs ([d3fbe84](https://github.com/ScriptedAlchemy/tracedecay/commit/d3fbe84a63c82740db23132666119a9caecc1eda))
* **ci:** sdk-codegen-packages ([9a98301](https://github.com/ScriptedAlchemy/tracedecay/commit/9a98301e0458a7249b570242546dc4911eabd298))
* **ci:** tests-daemon-fault-har ([e653a2e](https://github.com/ScriptedAlchemy/tracedecay/commit/e653a2e8390d78f74d36de3c86e91c0ef46c251d))
* **cli:** accept -p/--path on init like other commands ([461b16c](https://github.com/ScriptedAlchemy/tracedecay/commit/461b16cf875c525cc420b25e7d60c4016e026df7))
* **cli:** address boundary review findings ([1bf7506](https://github.com/ScriptedAlchemy/tracedecay/commit/1bf75061fdebfe55ea153693c8a2c86c43ce3889))
* **cli:** fail the process when a tool result reports isError ([aa38d9d](https://github.com/ScriptedAlchemy/tracedecay/commit/aa38d9df0e8db0b4b5ba1a0d83d07884fbd45f73))
* **cli:** import the truncation helpers from their real module ([9bda6e9](https://github.com/ScriptedAlchemy/tracedecay/commit/9bda6e93bc5b3bac2b16cccf332e30ddd56d7003))
* **clippy:** allow too_many_arguments on writer process_batch ([eaf507d](https://github.com/ScriptedAlchemy/tracedecay/commit/eaf507dade5837bd4c1e2d47d0c9237c8eefd6e4))
* **cli:** retrieve truncated tool responses ([e932412](https://github.com/ScriptedAlchemy/tracedecay/commit/e932412cbc381c989987c5da576de188c155164d))
* **cli:** test truncation through the public boundary ([492ca66](https://github.com/ScriptedAlchemy/tracedecay/commit/492ca66d072963ee80f1c301ce1798c54bea70ad))
* **cli:** wire the explicit init path flag ([69fa14a](https://github.com/ScriptedAlchemy/tracedecay/commit/69fa14a59fbd5435fa1c803f66fef77cdbbf9bc9))
* **code-extraction:** make hotpath counters truthful ([8bbfb60](https://github.com/ScriptedAlchemy/tracedecay/commit/8bbfb608c9c29a6a1087a71896666f72ca097b2a))
* **code-index:** carry the increment path through the new extract shape ([af72530](https://github.com/ScriptedAlchemy/tracedecay/commit/af7253019e90a28834c42db1c53ac8f48aa3a5df))
* **code-index:** gate hotpath helpers and drop while_let_loop ([501ccd2](https://github.com/ScriptedAlchemy/tracedecay/commit/501ccd20686ff9a7c7fe3b8df198b1f264c5b82c))
...
* **code-index:** stream ast-grep lines without a full collect ([9370b8d](https://github.com/ScriptedAlchemy/tracedecay/commit/9370b8d8eaec7eaca5774be11c9c0911f5eb2faa))
* **code-index:** stream grep lines without a full collect ([a23fcbd](https://github.com/ScriptedAlchemy/tracedecay/commit/a23fcbdf6452f66bdcb2ea112a40fa4f4d42cda2))
* **daemon:** admit retained session reads by checkout identity ([ec5cce6](https://github.com/ScriptedAlchemy/tracedecay/commit/ec5cce6bf9068b5f07e1d240ab0bba5fe4b674ca))
* **daemon:** balance scheduler hotpath gauges ([c28ab45](https://github.com/ScriptedAlchemy/tracedecay/commit/c28ab45ca03fd11d930f88a9b6883336efbadf4a))
* **daemon:** bound the proxy drain after a client disconnects ([1694295](https://github.com/ScriptedAlchemy/tracedecay/commit/16942957f3be396db4a419e37981d4f99e130f8c))
* **daemon:** clear scheduler gauges on shutdown ([3b139a7](https://github.com/ScriptedAlchemy/tracedecay/commit/3b139a7f8245191dc3952cbcf1ee2f2b2b1b92ed))
...
* **daemon:** own summary ids in the lcm expansion stream ([1b4cbe6](https://github.com/ScriptedAlchemy/tracedecay/commit/1b4cbe6ca6654d689f6c0d91d1e1d2d04093d7ed))
* **daemon:** retire temporal scheduler with evicted owners ([8dc780a](https://github.com/ScriptedAlchemy/tracedecay/commit/8dc780ae44ce6c68678be41db645a43d88386dc0))
* **daemon:** stop panicking on unavailable callable pages ([59012a6](https://github.com/ScriptedAlchemy/tracedecay/commit/59012a6f9f20494af3eebd0d117318c0864b3a8d))
* **dashboard-api:** box the admission rejection, drop dead borrows ([3da7999](https://github.com/ScriptedAlchemy/tracedecay/commit/3da79998b642d5362a0b5805e70dfd54a93977c8))
* **dashboard-api:** box the oversized admission rejection ([a069942](https://github.com/ScriptedAlchemy/tracedecay/commit/a069942d251cf5bb72b6749a5ee5e71062cdcd26))
* **dashboard-api:** gate unused StatusCode import ([0d3b98a](https://github.com/ScriptedAlchemy/tracedecay/commit/0d3b98a5aae1869bb1782ab9cf0118b95d824291))
* **dashboard-api:** qualify the admission control Result ([a748d7a](https://github.com/ScriptedAlchemy/tracedecay/commit/a748d7aa66d80481a60cc77c4cc1cfdd64ef781a))
* **dashboard:** back off explorer polling instead of giving up ([7aa0937](https://github.com/ScriptedAlchemy/tracedecay/commit/7aa09375650c4b76d2139907c58ac810ec7fdee4))
* **dashboard:** keep polling explorer runs through transient reads ([24a9e6b](https://github.com/ScriptedAlchemy/tracedecay/commit/24a9e6b3beeeb405d91c8350ce8cb18fe3e6d6f8))
* **dashboard:** narrow composeWeave input and complete trace fixture ([0995e45](https://github.com/ScriptedAlchemy/tracedecay/commit/0995e456339fb520dfd4d66c1f18f17eb1b82bad))
* **dashboard:** pass code_index_workers through user settings mutation ([166d8e9](https://github.com/ScriptedAlchemy/tracedecay/commit/166d8e9a9bb13a792dede90928ba8ffec31a8905))
* **dashboard:** type hook analytics window bounds ([c7eb51f](https://github.com/ScriptedAlchemy/tracedecay/commit/c7eb51ffc7919457a905537774a1000bd96193f3))
* **db:** deduplicate identical branch arms in profile_project_root ([55cfba7](https://github.com/ScriptedAlchemy/tracedecay/commit/55cfba7ea1b54ae3e6ad7daae8cd6e0c35ee445f))
* **domain:** derive Default for the worker selection ([f3dbc6f](https://github.com/ScriptedAlchemy/tracedecay/commit/f3dbc6f762aa731f3c47d8efdb3c9d42e39c7b15))
* **domain:** scope the newtype macro re-export to the crate ([baa2f9d](https://github.com/ScriptedAlchemy/tracedecay/commit/baa2f9de6f7365c40b7ce30540a00c2239528cca))
* **extraction:** normalize anonymous test suite titles ([d8a97e6](https://github.com/ScriptedAlchemy/tracedecay/commit/d8a97e6500d1202036cdf52920a9475c33f7d47e))
* **global-db:** borrow the summary row for each column read ([4371f46](https://github.com/ScriptedAlchemy/tracedecay/commit/4371f46a13e2685d8249b9311e017a9c4d407b45))
* **global-db:** drop the const initializer on the path cache ([66f1178](https://github.com/ScriptedAlchemy/tracedecay/commit/66f1178e615da09115673940e8ce238db81527f6))
* **global-db:** fail hydration storage errors closed ([764c676](https://github.com/ScriptedAlchemy/tracedecay/commit/764c676fbdc3617bf9cd3a1ac2351126fcacffb2))
* **global-db:** preflight observation batches atomically ([da7a207](https://github.com/ScriptedAlchemy/tracedecay/commit/da7a207f858ff8833c0930f0059c6dfb05ae85df))
* **global-db:** prove collision fast-path work ([8e91fef](https://github.com/ScriptedAlchemy/tracedecay/commit/8e91fefc0d38d06d1b6962d02516b733d5f4707d))
* **global-db:** remove synthetic scan telemetry ([0518f47](https://github.com/ScriptedAlchemy/tracedecay/commit/0518f4732ff26330419853492dd843c70b0cc1d3))
* **global-db:** reopen the SQL literal after the cursor-bound macro ([2425cc9](https://github.com/ScriptedAlchemy/tracedecay/commit/2425cc9eb06e58e1060a99cd489ab9fe312b24c1))
* **global-db:** scope admission work traces ([5803ed0](https://github.com/ScriptedAlchemy/tracedecay/commit/5803ed0943a1007dddc4cee4a08645ab8efd10f6))
* **global-db:** skip history-only temporal discovery scans ([1b821a4](https://github.com/ScriptedAlchemy/tracedecay/commit/1b821a49e0a9084f048de42f4aeb0c7dcbc6d720))
* **graph-db:** unshadow profiler and skip idle recover hydrate ([c935c21](https://github.com/ScriptedAlchemy/tracedecay/commit/c935c2172f71316e87c695342a9259850c314aee))
* **hooks:** accept released byte-array append intents ([c8f8499](https://github.com/ScriptedAlchemy/tracedecay/commit/c8f849955b3a173c78fed5aa6bb6c2d301df4878))
* **hooks:** enforce the total session hint cap ([040905a](https://github.com/ScriptedAlchemy/tracedecay/commit/040905ad4b9df4bf75cf73d443581f4c8f7a9108))
* **hooks:** export benchmark telemetry helpers ([59bb46b](https://github.com/ScriptedAlchemy/tracedecay/commit/59bb46b3b385a353f8b9dff9beee06a6214d1541))
* **hooks:** gate profiler-only spool scans ([ffe9d6a](https://github.com/ScriptedAlchemy/tracedecay/commit/ffe9d6ad19d1a9f4261e12f39cce69eaffb78e64))
* **hooks:** gate the test-only codex context helper ([baa8d01](https://github.com/ScriptedAlchemy/tracedecay/commit/baa8d0109e0443cdc7453f16647bdad098d224b2))
* **hooks:** restore shipped Codex additional-context alias ([d8a1888](https://github.com/ScriptedAlchemy/tracedecay/commit/d8a18882ce12cefde98a94b9f4f9122fcc8f46be))
* **hotpath:** compile projectless tool identity ([98532a2](https://github.com/ScriptedAlchemy/tracedecay/commit/98532a2096585e11989324058046bb04b57c39c0))
* **http:** eliminate disabled response probes ([f5468dc](https://github.com/ScriptedAlchemy/tracedecay/commit/f5468dc071872586afb6bf9dd403341ed4a54d2f))
* **ledger:** scope pruning to validated incarnation ([84df647](https://github.com/ScriptedAlchemy/tracedecay/commit/84df647f50e300e1a93323d566c00c12c29b0f0e))
* **lint:** clear pedantic clippy debt unmasked by the runtime-core fix ([b4d0686](https://github.com/ScriptedAlchemy/tracedecay/commit/b4d068682d9607d64ad3772689e266099b974b5b))
* **perf:** clear clippy blockers across the hotpath instrumentation ([0aba608](https://github.com/ScriptedAlchemy/tracedecay/commit/0aba608bf126e3e0cd541825b478d811d6e85142))
* **perf:** eliminate feature-off profiling work ([08377f4](https://github.com/ScriptedAlchemy/tracedecay/commit/08377f42345feeb5b32e7f6cf4a8a9d1256edb32))
...
* **query:** declare the rusqlite cache feature instead of inheriting it ([c6bdf69](https://github.com/ScriptedAlchemy/tracedecay/commit/c6bdf69e771fb86b700cbfdf7611211e9b83c264))
* **query:** remove feature-off sampling work ([9c3e103](https://github.com/ScriptedAlchemy/tracedecay/commit/9c3e1039b3ef613d0315353275c4be7538a6a884))
* **query:** repair the artifact finalization gauges ([0da99c1](https://github.com/ScriptedAlchemy/tracedecay/commit/0da99c1764d0898e7e7ee93e5099cdde78406d49))
* **query:** use stable Windows file identity ([26087ea](https://github.com/ScriptedAlchemy/tracedecay/commit/26087ea7ae69baa2c52d5ae694394e82024c0e09))
* **query:** use stable Windows file identity ([1da54aa](https://github.com/ScriptedAlchemy/tracedecay/commit/1da54aad79518c00d15a795b8e2ed4e36b5e9cc9))
* restore green master CI (format, clippy, identity-cutover fail-closed) ([703cee2](https://github.com/ScriptedAlchemy/tracedecay/commit/703cee280f10caed9ab0bee70e30ec6a89669dfa))
* **runtime-core:** commit the missing background CPU module ([d186a6a](https://github.com/ScriptedAlchemy/tracedecay/commit/d186a6acb196da73f62959adc0d8b33b3714cd8a))
* **runtime:** derive Linux cpu_percent from process ticks ([630c437](https://github.com/ScriptedAlchemy/tracedecay/commit/630c437ed7440efe8e68469ac9421ecd914e28f9))
* **rusqlite-runtime:** bound digest fallback memory ([67e3782](https://github.com/ScriptedAlchemy/tracedecay/commit/67e3782f348bfe5f6688f7a6a66a042bd0d3f1e9))
* **rusqlite-runtime:** compare the owned anchor owner by value ([d8d1229](https://github.com/ScriptedAlchemy/tracedecay/commit/d8d1229be5555c669469691899b04b53fc673967))
* **rusqlite-runtime:** enable the rusqlite cache feature ([19c4f5d](https://github.com/ScriptedAlchemy/tracedecay/commit/19c4f5df2df05edaf30958cdbacbf2a3f6e11f48))
* **rusqlite-runtime:** name encoded lock work truthfully ([e45ea9a](https://github.com/ScriptedAlchemy/tracedecay/commit/e45ea9a1c192d9ab998e03f27a55a446e4283482))
* **rusqlite-runtime:** skip scheduled WAL sample below soft ([88b3d0e](https://github.com/ScriptedAlchemy/tracedecay/commit/88b3d0e7bc21d9e635de3c7d60ebaaeb0eb8d2e0))
* **rusqlite-runtime:** stop digest full-table ORDER BY ([1c39c24](https://github.com/ScriptedAlchemy/tracedecay/commit/1c39c24bac80ec631fc633a2c121d72d754edd2e))
* **scripts:** restore OS harness with proc tick bind ([3d77a19](https://github.com/ScriptedAlchemy/tracedecay/commit/3d77a19e5e108f6be00e495d6e0ae6ff05a8989a))
* **sdk:** gate the error-class recorders with their callers ([c880203](https://github.com/ScriptedAlchemy/tracedecay/commit/c880203b0112ebc70f8767d6301fbbc6998baf5c))
* **sdk:** regenerate TS ops for code_index_worker_selection ([869076b](https://github.com/ScriptedAlchemy/tracedecay/commit/869076bdcbc4e9544e93bda667eda71617ea1f94))
* **semantic:** avoid feature-off telemetry classification ([86ba8c1](https://github.com/ScriptedAlchemy/tracedecay/commit/86ba8c1be8f438dde2e21d38f78440057eb469c2))
* **semantic:** gate fastembed hotpath recording ([8d624f7](https://github.com/ScriptedAlchemy/tracedecay/commit/8d624f7c46449b647e9119633dac8dc577b8a11b))
* **sessions:** bind prefix memo to file changes ([63ec9e6](https://github.com/ScriptedAlchemy/tracedecay/commit/63ec9e60fbc8d4716ef6a8b58111c0eb60ac9905))
* **sessions:** hold codex stdin open through the turn ([5353a56](https://github.com/ScriptedAlchemy/tracedecay/commit/5353a561f399855decb760208e8bc376de336d11))
* **sessions:** persist sweep-complete watermark after full rotation ([169e181](https://github.com/ScriptedAlchemy/tracedecay/commit/169e181eae6ec99c0ef81d354262ce17d51abe15))
* **sessions:** preserve batch cursor authority ([d2237cc](https://github.com/ScriptedAlchemy/tracedecay/commit/d2237cc6365220736d248bcb5ac273e429fc852d))
* **sessions:** report actual admission outcomes ([a091dce](https://github.com/ScriptedAlchemy/tracedecay/commit/a091dce674e898b018afb8e5dc343338b8ec3b3f))
* **sessions:** retain persist outcome classification ([80ba360](https://github.com/ScriptedAlchemy/tracedecay/commit/80ba3604bf33563a61cd3ca81e97ee8d3461de8e))
* **sessions:** tell a rename apart from a rewrite at revalidation ([ec9780c](https://github.com/ScriptedAlchemy/tracedecay/commit/ec9780c6720ae6144e34da00e57275e9b8d0ff47))
* **storage:** fail closed on populated exact-root duplicate stores ([776c779](https://github.com/ScriptedAlchemy/tracedecay/commit/776c779b0964e85ee624fb31371e81c0dd5b6df3))
* **store:** cap dependency batch to the exact-SQL row budget ([07a0347](https://github.com/ScriptedAlchemy/tracedecay/commit/07a0347ee86d8e02d563bac792e67f2d37ba2295))
* **temporal-query:** restore namespace clone in candidate loop ([81c3b98](https://github.com/ScriptedAlchemy/tracedecay/commit/81c3b98e5d897da5f8ad245208c26e057746c809))
* **tests:** restore the missing fs import in the mcp suite ([39db95e](https://github.com/ScriptedAlchemy/tracedecay/commit/39db95ef4e96de5addfc77715b814cce19ef6c5e))
* **usecases:** admit session reads by checkout identity ([98b1daf](https://github.com/ScriptedAlchemy/tracedecay/commit/98b1daf465abbf808d601e2f839672e0c56a00e4))
* **usecases:** drop the orphan Arc impl of the vector read port ([9e37ab2](https://github.com/ScriptedAlchemy/tracedecay/commit/9e37ab2a1f2f02f1678eec0fcab9f99a1d7d7753))
* **usecases:** identify Windows generations from opened handles ([b08720d](https://github.com/ScriptedAlchemy/tracedecay/commit/b08720de2b2eb697d8cd99d108cc89319b742fcf))
* **usecases:** report an absent diagnostics authority as a problem ([2cf5617](https://github.com/ScriptedAlchemy/tracedecay/commit/2cf5617d93d82596022def753cbcac79f8d8a2bd))


### Performance Improvements

* **agent-hosts:** measure Codex bundle write and host-bundle execute ([277020c](https://github.com/ScriptedAlchemy/tracedecay/commit/277020ceccb027c8b79f906a58a48fc1041966f7))
* **agent-hosts:** measure remaining host install boundaries ([aa4bcb0](https://github.com/ScriptedAlchemy/tracedecay/commit/aa4bcb066ea3c1f56aa502a2ebdfb3e19dc75b9f))
* **agent-hosts:** measure remaining host install writes ([c34d475](https://github.com/ScriptedAlchemy/tracedecay/commit/c34d475b7807e2aa434584d449296c91dd64f92e))
* **agent-hosts:** measure scheduler, scout, and host registry ([a95a084](https://github.com/ScriptedAlchemy/tracedecay/commit/a95a08472da63e01d71004d2e69384be49009106))
* **analytics:** honor sectioned retained reads ([111abf1](https://github.com/ScriptedAlchemy/tracedecay/commit/111abf15cf508212f002ebf78493b19351114e47))
* **analytics:** reuse hint-count authority and generation digest helper ([b46fc48](https://github.com/ScriptedAlchemy/tracedecay/commit/b46fc4863f88bd61fb6440665b5bf4140f41f6d3))
* **api:** measure remote brain HTTP admission ([3b7faa2](https://github.com/ScriptedAlchemy/tracedecay/commit/3b7faa278cb0994a3cc5b890bc483878ca6e9a8d))
* **application:** key workflow diffs and share read dispatch ([3cba5cc](https://github.com/ScriptedAlchemy/tracedecay/commit/3cba5cc7adcef4ddf24ceefbb334858cf139c5ef))
* **application:** measure commit_fact ([fbf0f1d](https://github.com/ScriptedAlchemy/tracedecay/commit/fbf0f1d1dc5772aca0fc70b04f24b5eff5120007))
* **application:** skip evidence root rehydrate and cap pages ([13f5ce6](https://github.com/ScriptedAlchemy/tracedecay/commit/13f5ce635decd738f614d0cc7c27a89aec048d40))
* **application:** time orchestration phases, not query-lane IO ([c50b2d2](https://github.com/ScriptedAlchemy/tracedecay/commit/c50b2d239e00ae0777942582a00ff502ab353994))
* **application:** time workflow fan-out census derivation ([14c313d](https://github.com/ScriptedAlchemy/tracedecay/commit/14c313d6c9813ed76d75f0fd5288cf7c34e4cd58))
* **automation:** measure backend invoke and skill parse ([9505d19](https://github.com/ScriptedAlchemy/tracedecay/commit/9505d1984a940f966997bb2a294d458cfb582fb2))
* **automation:** skip durable work for idle tasks ([408575e](https://github.com/ScriptedAlchemy/tracedecay/commit/408575e9a365d8d40f69fed73c90f5fa9fcd798b))
* **capture:** measure cursor composer envelope normalize ([c12e8c5](https://github.com/ScriptedAlchemy/tracedecay/commit/c12e8c5573df6c57ff46be88532c85af263ff84d))
* **capture:** measure source-record parse and cursor composition ([92989f2](https://github.com/ScriptedAlchemy/tracedecay/commit/92989f23d5907c5ef2109f348fc44a26c23e62e1))
* **cli:** probe storage reports off the async worker ([cdffee3](https://github.com/ScriptedAlchemy/tracedecay/commit/cdffee349fcbd908dcf456788830c581fb22232f))
* **code-extraction:** measure file parse and extract ([2920a2b](https://github.com/ScriptedAlchemy/tracedecay/commit/2920a2b2be6b0b612ae661e89285f6b0d5f2fb96))
* **code-index:** measure generation and search hot paths ([a395653](https://github.com/ScriptedAlchemy/tracedecay/commit/a3956531b9420b58c287dd6ac6a932bea3685371))
* **code-index:** measure graph manifest and ast-grep file ([332f2c7](https://github.com/ScriptedAlchemy/tracedecay/commit/332f2c75b10ec371cfdcfa8ad00d53cf765b12c5))
* **code-index:** measure intake, reuse keys, and pool persistence ([c886c77](https://github.com/ScriptedAlchemy/tracedecay/commit/c886c778bb008d92dae774eea505b3da3916d271))
* **code-index:** measure parse_and_extract ([8c8ffc4](https://github.com/ScriptedAlchemy/tracedecay/commit/8c8ffc47971d36ae5fff337254c977461cb4f2a5))
* **code-index:** release reuse lock before rematerializing ([c5ba95f](https://github.com/ScriptedAlchemy/tracedecay/commit/c5ba95f858ff92005e1247cfae8bc50a33eb5a4c))
* **code-index:** slice ast match lines by byte offset ([1c6ba90](https://github.com/ScriptedAlchemy/tracedecay/commit/1c6ba90cb9311beb3eabc0e25be2377288d69e91))
* **connection:** bound retained WAL files ([d4b62cb](https://github.com/ScriptedAlchemy/tracedecay/commit/d4b62cb23fd32e3e8d660ae9c98fb9ec3eb903ee))
* **daemon:** instrument HTTP surface and long-lived tasks ([7b13e5c](https://github.com/ScriptedAlchemy/tracedecay/commit/7b13e5c9753b46837715f6491417b367bdf5b8ee))
* **daemon:** measure admission surfaces and publish gauges ([5f3088d](https://github.com/ScriptedAlchemy/tracedecay/commit/5f3088d932d7939a4b581bfe86af27cf43908d32))
* **daemon:** measure LCM retrieval and portable open ([80b1d07](https://github.com/ScriptedAlchemy/tracedecay/commit/80b1d077551c7d428bb8752e6f145577bbfc77d4))
* **daemon:** measure MCP envelope handlers ([68f8e36](https://github.com/ScriptedAlchemy/tracedecay/commit/68f8e3601c7c2c675c723b8e94b34fa780f639b2))
* **daemon:** measure project-open query and hook dispatch ([2d95d27](https://github.com/ScriptedAlchemy/tracedecay/commit/2d95d273d70559da885bb477841b4af701b963e4))
* **daemon:** measure session-sync execute and status ([c3fa927](https://github.com/ScriptedAlchemy/tracedecay/commit/c3fa92798f8d572a23bd755ea47f7d01cfa6d215))
* **daemon:** measure tool dispatch and transcript batch persist ([9a8edd8](https://github.com/ScriptedAlchemy/tracedecay/commit/9a8edd830b0f8b08d1fc8c5087e103513402e725))
* **daemon:** measure update configuration and knowledge ([1c24ad9](https://github.com/ScriptedAlchemy/tracedecay/commit/1c24ad906a0ee336f3111f48f9fde682585cc5ee))
* **daemon:** reuse admission canonicalize and expand LCM in parallel ([0885759](https://github.com/ScriptedAlchemy/tracedecay/commit/08857592b724c5c1a7f092131235671c2ba0a330))
* **daemon:** wait on session-sync permits without polling ([cce801d](https://github.com/ScriptedAlchemy/tracedecay/commit/cce801d934caab76fd8711938e8edce60841caaa))
* **dashboard-api:** build typed analytics and batch LCM token counts ([fcdf1b5](https://github.com/ScriptedAlchemy/tracedecay/commit/fcdf1b591078af1572391fd39ad0e9257c637604))
* **dashboard-api:** fold typed analytics without JSON rows ([7167745](https://github.com/ScriptedAlchemy/tracedecay/commit/71677452b7327e08f863224d0d8d40f1b417f63e))
* **dashboard-api:** measure query and search routes ([b7f47f9](https://github.com/ScriptedAlchemy/tracedecay/commit/b7f47f9ed1b728f440976ad3d5cbc5970dc0bb90))
* **dashboard-api:** measure savings routes and project forward ([11669a6](https://github.com/ScriptedAlchemy/tracedecay/commit/11669a6be5b2ccca51de964fff304ab63770c46b))
* **dashboard-api:** measure similarity and leftover routes ([3f161ae](https://github.com/ScriptedAlchemy/tracedecay/commit/3f161ae3427a49c0538afa29b5110c87f95fe7dc))
* **dashboard:** memoize weaves and avoid SSE re-encode ([631976d](https://github.com/ScriptedAlchemy/tracedecay/commit/631976d4194026ee02a80a3fed8808da7f260d10))
* **dashboard:** memoize work readings and window code tables ([547d08f](https://github.com/ScriptedAlchemy/tracedecay/commit/547d08fd96886d95029a3ff01b4aff53d60a9675))
* **dashboard:** mutate ribbon scratch and reuse the pulse ring ([c0bc2ab](https://github.com/ScriptedAlchemy/tracedecay/commit/c0bc2ab1af5eb3cbf77cf82c0d8c4714a3364557))
* **exact-sql:** separate dispatch and lock timing ([8bb12ad](https://github.com/ScriptedAlchemy/tracedecay/commit/8bb12ad98a4399abfbdee6e344c802816a9a42f9))
* **external-source:** reuse prepared batch receipts ([7843998](https://github.com/ScriptedAlchemy/tracedecay/commit/7843998b9966cb466a41d3bc433fbcf858e6ba14))
* **extraction:** separate parsing from traversal demand ([10231aa](https://github.com/ScriptedAlchemy/tracedecay/commit/10231aa1a920e00aceee4c1c67f3b73dcad3d9d3))
* **extraction:** slice C/Rust/Dart/ObjC signatures to the body ([2fcb278](https://github.com/ScriptedAlchemy/tracedecay/commit/2fcb278406ae1e52a0be1e569f65c44b56955a86))
* **global-db:** add hotpath_observe gauges and measures ([c373092](https://github.com/ScriptedAlchemy/tracedecay/commit/c3730929d19b2bc359d9c9c23a00bf130c8f5f0c))
* **global-db:** batch LCM source-prep store and summary lookups ([2caad27](https://github.com/ScriptedAlchemy/tracedecay/commit/2caad272c5accda594a8c3cfdb37c0c2701e89eb))
* **global-db:** borrow observations and fail-closed retention counts ([b1e9dfa](https://github.com/ScriptedAlchemy/tracedecay/commit/b1e9dfa4415df49cf18ef5001afefcb710d77552))
* **global-db:** decode envelopes once and skip post-write SELECTs ([172e452](https://github.com/ScriptedAlchemy/tracedecay/commit/172e45239bf0fefddefbee17e27f0b014d94035b))
* **global-db:** measure temporal execute and hydration ([945dc7f](https://github.com/ScriptedAlchemy/tracedecay/commit/945dc7f357cab6e5f46d74c5c7914a833dd4b248))
* **global-db:** type session rows and share retrieval SQL fragments ([1db9fed](https://github.com/ScriptedAlchemy/tracedecay/commit/1db9fed67c700355bad07883a3cb1def0dda8ffb))
* **graph-db:** measure generation, traversal, and lock wait ([43b00a2](https://github.com/ScriptedAlchemy/tracedecay/commit/43b00a251b1b4365e1437644ed11080e089a78fa))
* **graph-db:** measure remaining recover/search kernels ([be2da37](https://github.com/ScriptedAlchemy/tracedecay/commit/be2da375108a0d622cf8a727a0afe7b79619fb2c))
* **graph-db:** measure traversal and vector search volume ([1c0e0d2](https://github.com/ScriptedAlchemy/tracedecay/commit/1c0e0d2bd926f443ac28f10feddf243e64e5d37b))
* **graph:** cache relation endpoints on bulk loads ([bea3ee4](https://github.com/ScriptedAlchemy/tracedecay/commit/bea3ee476ea9c7b5a6e3d12a0848eace4484c649))
* **graph:** memoize traversal identities and lazy fusion digests ([161e4bf](https://github.com/ScriptedAlchemy/tracedecay/commit/161e4bff58a287e9a55a1052fcdcb4aa10832ddb))
* **graph:** reuse the activated seal decode ([7b19478](https://github.com/ScriptedAlchemy/tracedecay/commit/7b19478b2a657b6e0003bf4c23ca1f7ca7157f95))
* **hooks:** fold last concurrent cursor and grep edits ([dd3bdb3](https://github.com/ScriptedAlchemy/tracedecay/commit/dd3bdb3d885eea82b5ebc048dab11242c2ee939b))
* **hooks:** keep prompt steering turn-local ([08fe1d7](https://github.com/ScriptedAlchemy/tracedecay/commit/08fe1d7f3cc66c69f95b1c2e9e29916550f719fa))
* **hooks:** measure admission ledger fsync ([70bad7c](https://github.com/ScriptedAlchemy/tracedecay/commit/70bad7ca9ae987d91ca30b1cc854c7fea8c29699))
* **hooks:** measure hook dispatch and capture outcomes ([a7f777b](https://github.com/ScriptedAlchemy/tracedecay/commit/a7f777bc740bfcbec7c5254aac7c0cb7fa87c103))
* **hooks:** measure spool fsync, replay, and delivery ack ([90c7de7](https://github.com/ScriptedAlchemy/tracedecay/commit/90c7de72b0d17fd065244a8867160b56447e5807))
* **hooks:** share context encoders and overlap deliveries ([04eb4b6](https://github.com/ScriptedAlchemy/tracedecay/commit/04eb4b602f0726e31430c7d79dce9040c330d81d))
* **hooks:** share hint EnvGuard and cheapen overlay/orphan scans ([fb65476](https://github.com/ScriptedAlchemy/tracedecay/commit/fb65476849fe5f5c7706371ce8fdaf29f0d33058))
* **hooks:** share host ingest timeout and semantic digest work ([0a7b802](https://github.com/ScriptedAlchemy/tracedecay/commit/0a7b802ee08d5cd73107e26000eec3646126cbd6))
* **hotpath:** trace every CLI and MCP dispatch ([6f1a568](https://github.com/ScriptedAlchemy/tracedecay/commit/6f1a5682d3c4fee3f078078b5beb5b80c7cd47a0))
* **http:** measure admission, encode, and SDK header/body split ([35d6619](https://github.com/ScriptedAlchemy/tracedecay/commit/35d661903b427052bf1a2c16d5e620790af647ee))
* **http:** profile complete application routes ([10d6c54](https://github.com/ScriptedAlchemy/tracedecay/commit/10d6c54861b5592d85234ce9a872b8fe3d123300))
* **http:** track application dispatch lifecycle ([f13ff3a](https://github.com/ScriptedAlchemy/tracedecay/commit/f13ff3a5073a5fd0aa9eb3578f0e8df34b977a68))
* **index:** filter symbols on borrowed names before materializing ([002bcb8](https://github.com/ScriptedAlchemy/tracedecay/commit/002bcb863005e789f9775532e805c0573aa6c155))
...
* **lsp:** box the widest semantic-request futures ([0267489](https://github.com/ScriptedAlchemy/tracedecay/commit/026748994c5858919ff3b5623afc0aa82e6eb7e8))
* **lsp:** measure gateway semantic request dispatch ([f7fe2ff](https://github.com/ScriptedAlchemy/tracedecay/commit/f7fe2ff999df54e834636d48a65942f166666362))
* **lsp:** reuse overlay digests and share Codex usage counters ([47aebce](https://github.com/ScriptedAlchemy/tracedecay/commit/47aebceb573b03a288e91b23635d065c6f7fb33a))
* **lsp:** serialize context envelopes once for the byte cap ([15b6401](https://github.com/ScriptedAlchemy/tracedecay/commit/15b6401e2b8b655a2bf993f3bdf079dad2efcdb5))
* **maintenance:** preserve due deadlines and phase progress ([b5a61c1](https://github.com/ScriptedAlchemy/tracedecay/commit/b5a61c1f79e9bf5fb32a58c22f875108669878a9))
* make writer cost attributable to its submitter ([2bb4161](https://github.com/ScriptedAlchemy/tracedecay/commit/2bb4161c510412758c39223b37d6e8e27aa3f290))
* **mcp:** avoid duplicate response instrumentation ([3d19261](https://github.com/ScriptedAlchemy/tracedecay/commit/3d19261b84cb7a392d89ce969fb6acb8cbb7363b))
* **mcp:** cache the static tools/list catalog ([c662d39](https://github.com/ScriptedAlchemy/tracedecay/commit/c662d39bd7808c89637b05834a892cc142623d21))
* **mcp:** coalesce flight keys and offload source walks ([bf5da62](https://github.com/ScriptedAlchemy/tracedecay/commit/bf5da626f980f211d0a0ff70dfc046f10207ad81))
* **mcp:** move ledger snapshots off the request path ([9055b5e](https://github.com/ScriptedAlchemy/tracedecay/commit/9055b5e0577a73fdfcaa67e7a847afc0d90151e3))
* **memory:** batch fact loads and walk Jaccard without sets ([7a07fa3](https://github.com/ScriptedAlchemy/tracedecay/commit/7a07fa38d1a390173b872a4b8780b0096b9bd3b3))
* **observation:** batch admission and preparation ([64dbb4b](https://github.com/ScriptedAlchemy/tracedecay/commit/64dbb4bf15d6be6b6439a774b0483ba0f0b9df62))
* **private-fs:** measure framed-log publish, fsync, and recovery ([37b6b8e](https://github.com/ScriptedAlchemy/tracedecay/commit/37b6b8ebf961627ad20d95f3c59a9b264e720f36))
* **query:** batch lexical artifact SQL probes ([101cf72](https://github.com/ScriptedAlchemy/tracedecay/commit/101cf7251fc0b6d1b0c42ed89ebf036502861a6b))
* **query:** measure retrieval lanes and lexical artifacts ([c16cbc3](https://github.com/ScriptedAlchemy/tracedecay/commit/c16cbc30d0ebef1f15cd0d0b8359e6564d30406f))
* **query:** measure retrieval lanes and lexical artifacts ([b3f8199](https://github.com/ScriptedAlchemy/tracedecay/commit/b3f8199bf8ecfd0e4064c725c917be1ea3e6beab))
* **query:** resolve each exact-field encoding in one lookup ([0c81df4](https://github.com/ScriptedAlchemy/tracedecay/commit/0c81df465ddfac46be0a85eab93836072c0f7dfb))
* **query:** use domain digests and borrow artifact chunks ([f4838f7](https://github.com/ScriptedAlchemy/tracedecay/commit/f4838f70ca4a71436e49f4023578335d94e1d62e))
* **retention:** skip idle generation hashing ([c6c42cd](https://github.com/ScriptedAlchemy/tracedecay/commit/c6c42cd02ff5aba72d8f5b9162f39ee9650994e7))
* **runtime-core:** inline lease gauges at acquire and release ([0883060](https://github.com/ScriptedAlchemy/tracedecay/commit/088306003a0e70ab94655eeb3a92a1adf03f672f))
* **runtime-core:** instrument lease, memory, and git hotpaths ([ffa481e](https://github.com/ScriptedAlchemy/tracedecay/commit/ffa481e55377b7185bda42b61dee48e623f9ba64))
* **runtime-core:** profile the registry and snapshot locks ([777d1d7](https://github.com/ScriptedAlchemy/tracedecay/commit/777d1d71ce1a168a3d67d9ea4d81c53c2fa28419))
* **runtime-core:** restore writer telemetry snapshot ([cb64e06](https://github.com/ScriptedAlchemy/tracedecay/commit/cb64e06442e2afb6c43b87f784ff54582782a447))
* **runtime:** cache exact-SQL statements and batch anchors ([b5f95e0](https://github.com/ScriptedAlchemy/tracedecay/commit/b5f95e0d9c4d222e7efc33fb12634db004c34ed7))
* **runtime:** cache Linux clock tick authority ([06fe96c](https://github.com/ScriptedAlchemy/tracedecay/commit/06fe96cca8cab2916914ea30bbb53ec42e7d54d6))
* **runtime:** collapse hot-path clones, N+1 SQL, and digest re-rolls ([56ca81d](https://github.com/ScriptedAlchemy/tracedecay/commit/56ca81d901529eb90feabf04e3b58eb986b3ab9b))
* **runtime:** coordinate background worker resources ([96564b7](https://github.com/ScriptedAlchemy/tracedecay/commit/96564b7e9cd9cf4cc290b883f6a50279d8a160df))
* **runtime:** drop leftover identifier and catalog clones ([064c97a](https://github.com/ScriptedAlchemy/tracedecay/commit/064c97a3b75ccd1cc6a34b34c77bab29c1320bb2))
* **runtime:** finish leftover lexical, grep, and hook path cleanups ([9dbf011](https://github.com/ScriptedAlchemy/tracedecay/commit/9dbf01115bb82ff160b069a1f3023dda20f38d67))
* **runtime:** profile startup and telemetry phases ([19a1f90](https://github.com/ScriptedAlchemy/tracedecay/commit/19a1f90a13cfd41926f526ad1c111a5540afecd5))
* **runtime:** simplify PR 421 hot paths and shared digest authority ([405d3c7](https://github.com/ScriptedAlchemy/tracedecay/commit/405d3c7757c36f54d4d264a9ec9519e4445a0956))
* **rusqlite-runtime:** measure deferred and snapshot begins ([6a927a8](https://github.com/ScriptedAlchemy/tracedecay/commit/6a927a8c64c0114028f8b4c2714e63414c6d3a13))
* **rusqlite-runtime:** measure sync and begin_immediate ([44e0f3a](https://github.com/ScriptedAlchemy/tracedecay/commit/44e0f3ae8933f2f15d5feb767bd18484b730f87a))
* **rusqlite-runtime:** measure writer, reader, WAL, and exact-SQL ([cfae557](https://github.com/ScriptedAlchemy/tracedecay/commit/cfae5576f63ccfa6ca556230c3d12a35a6e63881))
* **rusqlite:** expose writer queue and transaction costs ([4506339](https://github.com/ScriptedAlchemy/tracedecay/commit/4506339c7f918a5ee254aa479056701de6987e70))
* **rusqlite:** profile the writer admission lock ([c27e85e](https://github.com/ScriptedAlchemy/tracedecay/commit/c27e85e84528a3fc9073748f6e9f00416da715f7))
* **sdk:** measure execute_mcp ([ada24af](https://github.com/ScriptedAlchemy/tracedecay/commit/ada24af97e0eab296ba3bd9d7cd70779dca00ca0))
* **search-eval:** compose each partition query once ([bef84fc](https://github.com/ScriptedAlchemy/tracedecay/commit/bef84fc772546ab29d4eb518bd8cf8a2a499f119))
* **semantic:** measure embed and encode batches ([b8ca239](https://github.com/ScriptedAlchemy/tracedecay/commit/b8ca2394c40ba8b15b3c04164f7e0d12941ecda8))
* **semantic:** measure model load, pool wait, and artifact cache ([66a25a1](https://github.com/ScriptedAlchemy/tracedecay/commit/66a25a18321d6a83156348e20fcd78cb18ff84b1))
* **semantic:** measure query-time embed ([9227f93](https://github.com/ScriptedAlchemy/tracedecay/commit/9227f93c71cc4596b1fadabf75dcf0683cdbd97e))
* **semantic:** reserve per-session bytes, not process budget ([aba1ad7](https://github.com/ScriptedAlchemy/tracedecay/commit/aba1ad7c2d750a6fc5af4302337ee6a59b24f751))
* **sessions:** avoid redundant jsonl scan work ([770174b](https://github.com/ScriptedAlchemy/tracedecay/commit/770174be34536ba9542e7dc864077e1e04529d0f))
* **sessions:** batch external source projections ([b8ef440](https://github.com/ScriptedAlchemy/tracedecay/commit/b8ef440b4c38a5b66590d90dc19fd61e3797c0f7))
* **sessions:** batch LCM GC marks and reuse describe counts ([1a6ceac](https://github.com/ScriptedAlchemy/tracedecay/commit/1a6ceac204c6151b0b03c4e351bd2fc089798597))
* **sessions:** decouple history retries from projection scans ([09b1d19](https://github.com/ScriptedAlchemy/tracedecay/commit/09b1d19a26fb536bf92f7285b97d9413b4660bf9))
* **sessions:** enumerate each Codex bucket once per discovery pass ([3313413](https://github.com/ScriptedAlchemy/tracedecay/commit/33134131f2dbeaa5a17e2d8f4188864e06aab224))
* **sessions:** expose refresh scheduler lifecycle ([fdcb5d4](https://github.com/ScriptedAlchemy/tracedecay/commit/fdcb5d4d3c1e06a425c065b8633d8826a002d7b0))
* **sessions:** measure discovery, JSONL IO, LCM, and git backfill ([e889019](https://github.com/ScriptedAlchemy/tracedecay/commit/e8890190c44665987d0e38151c2fa88be523e721))
* **sessions:** measure JSONL parse and persist sweep coverage ([73f8583](https://github.com/ScriptedAlchemy/tracedecay/commit/73f858375264efcc16d58a3b50da3182f5989e7c))
* **sessions:** measure leftover ingest file and stream kernels ([1c34010](https://github.com/ScriptedAlchemy/tracedecay/commit/1c340108144bf803a2fdfc50d70c7cb2cc21f899))
* **sessions:** mount atomic observation capture batches ([a71e690](https://github.com/ScriptedAlchemy/tracedecay/commit/a71e690f38df10884204b021f7455cf457e83e42))
* **sessions:** parse transcript metadata once and reuse companions ([1120f61](https://github.com/ScriptedAlchemy/tracedecay/commit/1120f61b26416000e96b9e9671f7b818447ce96f))
* **sessions:** share bounded transcript preparation ([5659408](https://github.com/ScriptedAlchemy/tracedecay/commit/565940801c253ba702cc33f9dc12772ea53e6016))
* **sessions:** skip settled JSONL content reads ([f8c7c48](https://github.com/ScriptedAlchemy/tracedecay/commit/f8c7c4806c2280146925bdb146d29f9a25cda3d2))
* **sessions:** skip unchanged prefix walks and append snapshots ([35e3910](https://github.com/ScriptedAlchemy/tracedecay/commit/35e3910bac66f9b7ccc7b43f333c516a3a796ff3))
* **sessions:** stop the tombstone probe at the first confirmed row ([f730482](https://github.com/ScriptedAlchemy/tracedecay/commit/f730482c749fbe7ca5778e59014f0af4911e7c80))
* **storage:** commit observation batches atomically ([1d6dcd6](https://github.com/ScriptedAlchemy/tracedecay/commit/1d6dcd6ddcecb1296708f976a70a9915ce30fcb6))
* **store:** batch graph replay dependency reads ([08adf01](https://github.com/ScriptedAlchemy/tracedecay/commit/08adf019b088feeccb414911f060c74394a35c29))
* **store:** batch graph replay reads and bound Busy retries ([14f7287](https://github.com/ScriptedAlchemy/tracedecay/commit/14f728799548ee4a73eba9c61c45b180d508aec8))
* **store:** batch per-row session and curation reads ([c464b3f](https://github.com/ScriptedAlchemy/tracedecay/commit/c464b3fe03e263be91c4eaf72f1b49b86cef2426))
* **temporal-query:** time candidate funnel and stage counts ([64c99ff](https://github.com/ScriptedAlchemy/tracedecay/commit/64c99ff65174e071dd921cba02929e70f924ea94))
* **temporal:** bound projection refresh work ([82dffe9](https://github.com/ScriptedAlchemy/tracedecay/commit/82dffe98d22d9c98382eca37946017d20a4d86e3))
* **usecases:** add hotpath_observe gauges and measures ([4d9f2fd](https://github.com/ScriptedAlchemy/tracedecay/commit/4d9f2fd1c052b3c8e65ac6ccaf4fcbe8e33b835c))
* **usecases:** batch host admission persist ([76690de](https://github.com/ScriptedAlchemy/tracedecay/commit/76690de0764dea909401c2dd961af828b430fccc))
* **usecases:** eliminate disabled profiling work ([7ca6f98](https://github.com/ScriptedAlchemy/tracedecay/commit/7ca6f983c8f9d5fffd241594ab311cf1a5d3ae4e))
* **usecases:** keep grep symbol memoization current ([3476a45](https://github.com/ScriptedAlchemy/tracedecay/commit/3476a4588049c3ac9f51ab836bcb777e09d0d27f))
* **usecases:** measure batch capture and commit_fact ([88eaa06](https://github.com/ScriptedAlchemy/tracedecay/commit/88eaa067336bd5712efd3bd9e3d5fbeda52dc760))
* **usecases:** measure outbound GitHub HTTP ([96ade5e](https://github.com/ScriptedAlchemy/tracedecay/commit/96ade5e201121021cdf53e2f653aa7b97da9e44e))
* **usecases:** share graph census and concurrent file metadata ([5e22874](https://github.com/ScriptedAlchemy/tracedecay/commit/5e22874d457e9c7916f2ca5b5b34cf9bce7d8cc2))
* **usecases:** take feedback runtime and reuse digest helpers ([6d0a3b8](https://github.com/ScriptedAlchemy/tracedecay/commit/6d0a3b8f02c290ace225135698f38e437492cbd0))
* **writer:** coalesce compatible queued writes ([11906c0](https://github.com/ScriptedAlchemy/tracedecay/commit/11906c0c6789b1aaa68f31aae995ed2cd72351c8))


### Reverts

* **privacy:** move gitleaks catalogue to PR [#707](https://github.com/ScriptedAlchemy/tracedecay/issues/707) ([064a0ed](https://github.com/ScriptedAlchemy/tracedecay/commit/064a0ed2df38f413ca7e20bf9cb923d8ecd89ecb))
* **privacy:** move gitleaks catalogue to PR [#707](https://github.com/ScriptedAlchemy/tracedecay/issues/707) ([48d86e5](https://github.com/ScriptedAlchemy/tracedecay/commit/48d86e58a5d575f8e2d55eb1f7855bd9153f68f6))
* **runtime-core:** keep driver telemetry private ([7771a42](https://github.com/ScriptedAlchemy/tracedecay/commit/7771a4258cb5046e77a13a3d6a27df71293368dc))
* **rusqlite-runtime:** keep WAL pressure authoritative ([ab57c7c](https://github.com/ScriptedAlchemy/tracedecay/commit/ab57c7c58bd5a09e615f24a9955b24b3c2381c7f))
* **scripts:** drop bespoke hotpath OS harness ([befba30](https://github.com/ScriptedAlchemy/tracedecay/commit/befba30d8c51bec30f539789a0a7860949abd17c))
* **scripts:** remove reintroduced OS harness ([60faa8c](https://github.com/ScriptedAlchemy/tracedecay/commit/60faa8cdab2eb3e6b01b2ad5473322357ec43338))
