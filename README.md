...
- `SessionStart` — emits `hookSpecificOutput.additionalContext` steering the agent toward tracedecay MCP tools and reporting index freshness (suggests `tracedecay init` when no initialized project store is found).
