...
description: Review a PR or working-tree diff for impact, risk, and quality using the code graph. Use for "review this diff", "review this PR", "TraceDecay review", change-set risk review, or pre-merge checks.
---
