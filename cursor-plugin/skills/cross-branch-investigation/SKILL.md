...
description: Search and compare code across git branches without switching your checkout, using TraceDecay's per-branch graphs. Use for "does symbol X exist on main", "what changed between branch A and B", cross-branch diff/search, or checking another branch's API before you depend on it.
---
