...
This folder is the authoritative implementation reference for the approved Delivery states. Delivery begins as an all-project pull-request inbox, narrows by project or agent, groups correlated cross-repository pull requests into umbrella Deliveries, and opens each PR as a causal, replayable review journey.
