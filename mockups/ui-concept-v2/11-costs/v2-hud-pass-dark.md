...
Capture the historical v2 hud pass dark direction for Costs.
...
Synthetic historical composition for v2 hud pass dark; not a current semantic-state selection.
