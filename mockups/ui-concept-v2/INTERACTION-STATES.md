...
1. Follow loaded tail: follow the newest event in the loaded page without
   claiming a complete daemon, provider, host, or global live tail.
2. Temporal replay: play, seek, or step through loaded evidence while
   unrevealed future events remain hidden.
