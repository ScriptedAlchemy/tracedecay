...
Known defect: activity rendering lacks required separate Feed and Authority states for admitted activity. Lifecycle is an explicit editorial decision; the version stem records iteration order only.
