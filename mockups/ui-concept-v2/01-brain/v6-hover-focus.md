...
Known defect: hover treatment does not prove a supported inspect path and risks conflating hover/focus with activity. Lifecycle is an explicit editorial decision; the version stem records iteration order only.
