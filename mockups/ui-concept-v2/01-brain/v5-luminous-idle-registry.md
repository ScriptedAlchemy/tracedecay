...
Known defect: decorative idle luminosity can be read as activity or health, not a measured state. Lifecycle is an explicit editorial decision; the version stem records iteration order only.
