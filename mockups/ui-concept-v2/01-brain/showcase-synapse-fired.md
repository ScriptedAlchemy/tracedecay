...
This plate studies single firing synapse as an expressive brain hero.
...
Early synapse showcase replaced by the measured registry. Lifecycle is an explicit editorial decision; the version stem records iteration order only.
