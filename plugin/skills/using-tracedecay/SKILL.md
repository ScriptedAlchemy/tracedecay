...
| Need a saved document's combined post-edit diagnostics | `tracedecay_feedback_advisory_cycle`, then use its daemon-minted handle with the `tracedecay_feedback_*` reads |
