...
4. For captured compiler output, use `tracedecay_diagnose`; use fresh diagnostics, unsafe-pattern, and redundancy scans only where the changed surface warrants them.
