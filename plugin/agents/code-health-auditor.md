...
complexity and size, dependency structure, documentation, unsafe patterns,
structural test risk, and unmounted files. An unmounted file has no indexed
build root; confirm its real build or runtime path before treating it as dead.
