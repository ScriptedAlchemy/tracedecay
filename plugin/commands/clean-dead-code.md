...
code, unmounted-file, and compiler or language-server evidence to find
candidates. Confirm callers, references, runtime loaders, generated paths, and
external consumers as applicable before removing code; public symbols need
