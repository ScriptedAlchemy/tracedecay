...
copies. Pi is the MCP-free host: its extension registers the graph tools over
`tracedecay tool` and carries its lifecycle hooks inside the Pi process.
