...
class FdClassificationTests(unittest.TestCase):
    ...
    def test_hypothesis_is_bound_to_runtime_telemetry(self) -> None:
        ...
        self.assertTrue(hyp["still_true_on_linux_head"])
        ...
        self.assertIn("cpu_percent: process.cpu_usage()", source)
    ...
    def test_driver_one_workload_sample(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="hotpath-os-run-") as tmp:
            ...
            self.assertIn("cpu0 src/runtime_telemetry.rs::sample_process_with_window", completed.stdout)
