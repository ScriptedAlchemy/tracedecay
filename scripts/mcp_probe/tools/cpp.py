...
def probes_for(d):
    ...
    return {
        ...
        "tracedecay_complexity":        [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        "tracedecay_dead_code":         [{}, {"limit": 10}, {"include_public": False},
                                        {"path": "src"}, {"path": "lib"}],
        "tracedecay_circular":          [{}, {"limit": 5}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        "tracedecay_doc_coverage":      [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": files[0]}],
        "tracedecay_god_class":         [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        "tracedecay_dependency_depth":  [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        "tracedecay_inheritance_depth": [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        ...
        "tracedecay_recursion":         [{}, {"limit": 10}, {"path": "src"}, {"path": "include"}, {"path": "lib"}],
        ...
        "tracedecay_status":            [{}] * 5,
        "tracedecay_health":            [{}] * 5,
        "tracedecay_diagnose":          [{"cargo_output": "src/lib.cpp:1:5: error: use of undeclared identifier 'foo'"}] * 5,
        # port
