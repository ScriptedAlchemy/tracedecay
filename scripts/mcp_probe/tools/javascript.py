"""JavaScript / TypeScript probe inputs for scripts/mcp_probe/probe.py.

Mirrors the shape of `tools/rust.py`. Covers both vanilla JS and TS layouts
(`src/`, `lib/`, `tests/`, `test/`, `dist/`). Class names and base types use
common DOM / Node / React idioms so the matrix exercises something on most
real-world repos, even if the codebase doesn't actually extend any of them
(empty result still surfaces as EMPTY, which is the desired state).
"""

DEFAULT_NAMES = ["constructor", "render", "init", "main", "handle"]
DEFAULT_BASES = ["Component", "Error", "EventEmitter", "Promise", "Map"]
DEFAULT_TYPE_NAMES = ["Promise", "Map", "Array", "Error", "Event"]
DEFAULT_TASKS = [
    "error handling",
    "logging",
    "config parsing",
...
DEFAULT_PATHS = ["src", "lib", "tests", "test", "dist"]
...
def probes_for(d):
    ...
    return {
        ...
        "tracedecay_search":            [{"query": q} for q in
                                        ["main", "render", "Error", "Config", "Promise"]],
        ...
        "tracedecay_hotspots":          [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_complexity":        [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_dead_code":         [{}, {"limit": 10}, {"include_public": False},
                                        {"path": "src"}, {"path": "lib"}],
        "tracedecay_circular":          [{}, {"limit": 5}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_doc_coverage":      [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": files[0]}],
        "tracedecay_god_class":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_dependency_depth":  [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_inheritance_depth": [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_distribution":      [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tracedecay_gini":              [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tracedecay_largest":           [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_recursion":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_coupling":          [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": files[0]}],
        "tracedecay_dsm":               [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tracedecay_module_api":        [{"path": f} for f in files],
        "tracedecay_unused_imports":    [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_test_map":          [{"file": f} for f in files],
        "tracedecay_test_risk":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_todos":             [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tracedecay_files":             [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tracedecay_status":            [{}] * 5,
        "tracedecay_health":            [{}] * 5,
        "tracedecay_diagnose":          [{"cargo_output": "TypeError: undefined is not a function at src/lib.js:1:5"}] * 5,
        # port
        "tracedecay_port_status":       [
            {"source_dir": "src", "target_dir": "tests"},
            {"source_dir": "lib", "target_dir": "tests"},
            {"source_dir": "src", "target_dir": "lib"},
            {"source_dir": "src", "target_dir": "dist"},
