...
configuration_explain|read|{"key":"diagnostics.prewarm.v1"}
configuration_get|read|{"key":"diagnostics.prewarm.v1"}
...
configuration_set|mutate|{"key":"diagnostics.prewarm.v1","value":"true","layer":"project","expected_revision":"0"}
configuration_unset|mutate|{"key":"diagnostics.prewarm.v1","layer":"project","expected_revision":"0"}
