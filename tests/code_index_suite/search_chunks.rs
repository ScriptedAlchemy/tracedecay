...
use tracedecay::code_index::capabilities::{
...
use tracedecay::code_index::chunks::{CodeChunker, DeterministicCodeChunker};
use tracedecay::code_index::extract::{
    LanguageExtractor, MAX_EXTRACTION_SOURCE_BYTES, NeverCancelled, TreeSitterExtractor,
};
use tracedecay::code_index::languages::LanguageRegistry;
...
fn base_capability_manifest_is_deterministic_and_candidate_authorized() {
    ...
    assert_eq!(
        ...
        Err(tracedecay::code_index::capabilities::CapabilityEmissionErrorV1::MixedGeneration)
    );
}
