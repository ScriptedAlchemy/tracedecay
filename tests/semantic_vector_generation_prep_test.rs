...
use tracedecay::store::vector_generation_test_support::{
    CanonicalChunkVectorEncoderV1, DatabaseVectorGenerationStoreV1, ProjectionRequestBatchV1,
    SemanticProjectionErrorV1, VectorGenerationIdV1, VectorGenerationPlanV1, VectorGenerationState,
...
fn one_batch_and_multi_batch_publications_have_equal_generation_identity() {
    ...
    let mut single_store = VectorGenerationState::new();
    ...
    let mut multi_store = VectorGenerationState::new();
