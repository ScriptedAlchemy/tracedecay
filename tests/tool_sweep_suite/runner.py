...
def prime_fixture_values(
    ...
    prime_code_navigation(client, fixture, deadline("tracedecay_code_symbol_search"))
...
# One symbol-search page mints the exact node best suited to each navigation
# consumer. A single leaf cannot prove its callees, type edges, and hierarchy.
