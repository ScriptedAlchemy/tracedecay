...
Usage:
    python benchmark_data/run_benchmarks.py
    python benchmark_data/run_benchmarks.py --repos fastapi
    python benchmark_data/run_benchmarks.py --skip-clone
    python benchmark_data/run_benchmarks.py --skip-token-savior   # tracedecay only
    python benchmark_data/run_benchmarks.py --skip-tracedecay      # token-savior only
"""
