...
Isolation comes exclusively from benchmark_data/runtime/fixtures.py
(prepare_fixture_snapshot / isolated_environment) and
benchmark_data/runtime/lifecycle.py (OwnedDaemon), exactly as
benchmark_data/runtime/run.py uses them. No profile environment variable is
...
from benchmark_data.runtime.fixtures import (  # noqa: E402
    PreparedFixture,
...
from benchmark_data.runtime.lifecycle import OwnedDaemon  # noqa: E402
from benchmark_data.runtime.run import (  # noqa: E402
