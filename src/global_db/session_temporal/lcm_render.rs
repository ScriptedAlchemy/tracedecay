...
use crate::sessions::lcm::{LcmContentRange, LcmContentSlice, LcmExpandResponse, LcmSourceRef};

#[derive(Debug)]
pub(super) struct CanonicalLcmSourceHydration {
    pub(super) source_ref: LcmSourceRef,
    pub(super) state: HydrationStateV1,
    pub(super) content: Option<String>,
}

#[derive(Debug)]
pub(super) enum CanonicalLcmSourceHydrationError {
    Cardinality,
    Identity,
    InvalidContentState,
}
...
pub(super) fn apply_canonical_summary_source_content(
