...
use crate::daemon::store_runtime::registry::StoreRuntimeClientLease;
...
impl ObservationProjectionStore for GlobalDbObservationStore<'_> {
    ...
    async fn project_observation(
        ...
        crate::global_db::project_observation_with_engine(&connection, observation_id).await
    }
    ...
    async fn rebuild_projection(
        ...
        let connection = crate::db::engine::Connection::attach(handle);
        crate::global_db::rebuild_projection_with_engine(&connection, frontier_sequence).await
    }
}
