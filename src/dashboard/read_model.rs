...
// Builder/constructor surface is the normative contract; some entry points are
// not yet exercised by a server-side caller but are part of the generated API.
#[allow(dead_code)]
