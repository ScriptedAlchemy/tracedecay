...
pub use types::{
    ...
    LcmExpandTarget, LcmExpandedSummarySource, LcmGcConfig, LcmGrepHit, LcmGrepOutcome,
    LcmGrepRequest, LcmGrepSort, LcmLifecycleState, LcmLifecycleUpdate, LcmLoadSessionMessage,
