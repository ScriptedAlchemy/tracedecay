...
pub(crate) async fn reinstall_agent_integrations(
    ...
    reinstall_agent_integrations_inner(agent_ids, home, tracedecay_bin).await
}
...
pub(crate) async fn reinstall_agent_integrations_under_lease(
    ...
    home: &Path,
    tracedecay_bin: &str,
    _lifecycle: &tracedecay::lifecycle_lease::LifecycleLease,
) -> Vec<(String, tracedecay::errors::Result<AgentReinstallOutcome>)> {
    reinstall_agent_integrations_inner(agent_ids, home, tracedecay_bin).await
}

async fn reinstall_agent_integrations_inner(
    agent_ids: &[String],
    home: &Path,
    tracedecay_bin: &str,
) -> Vec<(String, tracedecay::errors::Result<AgentReinstallOutcome>)> {
