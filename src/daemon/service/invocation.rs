...
use tracedecay_application::{
    ...
    TaskHandoffError, TaskHandoffGrantV1, TaskHandoffIssueRequestV1, TaskHandoffRedeemRequestV1,
    TaskHandoffRedeemedV1, TaskHandoffToken, TemporalState, WorkAttemptResponseV1,
    WorkExecutionError, WorkProjectionApplicationError, WorkProjectionDeltaRequestV1,
    WorkProjectionSnapshotRequestV1, WorkflowActivationV1, WorkflowCoordinationError,
    WorkflowDefinitionActivateRequestV1, WorkflowDefinitionRegisterRequestV1,
    WorkflowExecutionTruthV1, WorkflowFanOutRequestV1, WorkflowFanOutRuntimeError,
...
#[allow(clippy::too_many_arguments)]
async fn execute_workflow_application(
    registered: RegisteredWorkRuntime,
    project_root: &Path,
    request_id: String,
    request: WorkflowApplicationInvocationV1,
...
impl DaemonInvocationService {
    ...
    /// Admit a workspace spanning several registered roots. Every root must
    /// carry its own capability grant, and the resulting `AuthorizedScopeSet`
    /// is compare-and-swapped into every participating store: that CAS, not
    /// the caller's folder list, is the authorization boundary.
    ...
    pub(crate) async fn invoke(
        ...
        let response = match request.payload {
            ...
            // Multi-root payloads never reach this dispatch: `invoke_for_project`
            // routes all three to the multi-root executor before the per-project
...
"#;
        ...
        let scope = ResolvedScope::new(
            ...
            tracedecay_domain::RepositoryId::new("repository.workflow.invocation")
                .expect("repository id"),
            tracedecay_domain::WorktreeId::new("worktree.workflow.invocation")
                .expect("worktree id"),
            None,
        )
        .expect("resolved scope");
        ...
        assert!(matches!(
            registered,
            DaemonInvocationOutcome::WorkflowApplication {
                outcome: WorkflowApplicationOutcomeV1::RegisterDefinition(
        ...
        assert!(matches!(
            activated,
            DaemonInvocationOutcome::WorkflowApplication {
                outcome: WorkflowApplicationOutcomeV1::ActivateDefinition(
                    ApplicationOutcome::Effect(_)
                ),
                ..
            }
        ...
        let fan_out = tracedecay_application::WorkflowFanOutRequestV1 {
            ...
            fence: tracedecay_application::WorkflowExecutionFenceV1 {
                ...
                lease: tracedecay_domain::WorkLeaseFenceV1::new(
                    tracedecay_domain::WorkLeaseId::new("lease.workflow.invocation")
                        .expect("lease id"),
            ...
            admitted_at: now,
            cancellation: CancellationContext::active("cancel.workflow.fan-out")
                .expect("cancellation"),
            max_parallel: 1,
            ...
            provider: tracedecay_application::WorkflowProviderAdmissionV1 {
                ...
                reference: None,
                commit: tracedecay_domain::CommitId::new(
        ...
        let settled_plan = tracedecay_application::prepare_workflow_fan_out(&settled_fan_out)
            .expect("settled plan");
        ...
        let DaemonInvocationOutcome::WorkflowApplication {
            outcome:
                WorkflowApplicationOutcomeV1::ExecuteFanOut(ApplicationOutcome::Effect(reconciled)),
            ..
        } = reconciled
        else {
        ...
        let interrupted_plan =
            tracedecay_application::prepare_workflow_fan_out(&interrupted_fan_out)
        ...
        let DaemonInvocationOutcome::WorkflowApplication {
            outcome:
                WorkflowApplicationOutcomeV1::ExecuteFanOut(ApplicationOutcome::Effect(resumed)),
            ..
        } = resumed
        else {
        ...
        let tracedecay_application::WorkflowExecutionTruthV1::Completed { checkpoint } = resumed
        else {
        ...
        cancelled_fan_out.run_id =
            tracedecay_domain::RunId::new("run.workflow.invocation.cancelled")
        ...
        let DaemonInvocationOutcome::WorkflowApplication {
            outcome:
                WorkflowApplicationOutcomeV1::ExecuteFanOut(ApplicationOutcome::Effect(cancelled)),
            ..
        } = cancelled
        else {
