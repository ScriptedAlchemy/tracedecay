...
impl HostAdmissionTestRuntimeV1 {
    ...
    pub async fn call_user_lcm_tool_for_test(
        ...
        profile_root: &Path,
    ) -> crate::errors::Result<crate::mcp::tools::ToolResult> {
    ...
    pub(crate) async fn retire_applied_input_manifests_for_test(
        &self,
        profile_root: &Path,
    ) -> crate::migrate::consolidate::ManifestRetirementReport {
        crate::migrate::consolidate::retire_applied_input_manifests(
            profile_root,
    ...
    pub async fn profile(profile_root: impl AsRef<Path>) -> crate::errors::Result<Self> {
    ...
    pub fn session_temporal_store_for_test(
        &self,
        scope: HostAdmissionScope,
    ) -> crate::errors::Result<crate::store::session::GlobalDbSessionTemporalStore<'_>> {
    ...
    ) -> crate::errors::Result<Option<(i64, tracedecay_domain::TemporalValidityV1)>> {
        let snapshot = self
            .session_database_for_test(scope)?
            .read_snapshot()
            .await
    ...
    pub async fn session_temporal_generation_for_test(
        ...
        session_id: &tracedecay_domain::SessionId,
        state: &str,
    ) -> crate::errors::Result<Option<u64>> {
        let snapshot = self
            .session_database_for_test(scope)?
            .read_snapshot()
            .await
        ...
        let mut rows = snapshot
            .query(
                ...
                crate::db::engine::params![session_id.as_str(), state],
            )
            .await
            .map_err(|error| crate::errors::TraceDecayError::Database {
    ...
    #[doc(hidden)]
    pub async fn registered_project_paths_for_test(&self) -> crate::errors::Result<Vec<PathBuf>> {
        self.profile_database
    ...
    ) -> crate::errors::Result<Vec<crate::global_db::AnalyticsEventRecord>> {
        self.profile_database
    ...
    #[doc(hidden)]
    pub async fn profile_analytics_indexes_present_for_test(&self) -> crate::errors::Result<i64> {
    ...
    #[doc(hidden)]
    pub async fn clear_project_aliases_for_test(&self) -> crate::errors::Result<u64> {
    ...
    pub async fn project_registry_context_by_alias(
        &self,
        alias_path: &Path,
    ) -> crate::errors::Result<Option<crate::global_db::ProjectRegistryContext>> {
        self.profile_database
    ...
    pub async fn resolve_project_store_by_identity(
        ...
        project_root: &Path,
        git_common_dir: Option<&Path>,
    ) -> crate::errors::Result<Option<crate::global_db::ProjectStoreResolution>> {
        self.profile_database
    ...
    ) -> Result<crate::migrate::registry::RegistryReconstructionApplyReport, Vec<String>> {
    ...
    pub(crate) fn host_admission_broker_for_test(
        &self,
        scope: HostAdmissionScope,
    ) -> crate::errors::Result<SharedHostAdmissionBroker> {
    ...
    pub async fn ingest_workflows_for_test(
        &self,
        project_root: &Path,
    ) -> crate::errors::Result<crate::sessions::workflow_ingest::WorkflowIngestStats> {
        let project_id =
            self.project_id
                .as_ref()
                .ok_or_else(|| crate::errors::TraceDecayError::Database {
    ...
    pub(crate) async fn read_snapshot(
        &self,
        scope: HostAdmissionScope,
    ) -> crate::db::engine::Result<crate::db::engine::ReadSnapshot> {
        match scope {
            HostAdmissionScope::Project => self
                .project_registered
                .as_ref()
                .ok_or_else(|| {
                    crate::db::engine::Error::invalid_operation(
    ...
    fn project_database_for_test(&self) -> crate::errors::Result<&RegisteredGlobalDb> {
    ...
    pub fn session_database_identity_for_test(
        &self,
        scope: HostAdmissionScope,
    ) -> crate::errors::Result<HostAdmissionDatabaseIdentityV1> {
        use sha2::{Digest as _, Sha256};
    ...
    ) -> crate::errors::Result<crate::config::PinnedRuntimeConfiguration> {
    ...
    pub fn transcript_store_for_test(
        &self,
        scope: HostAdmissionScope,
    ) -> crate::errors::Result<crate::store::GlobalDbTranscriptStore<'_>> {
    ...
    ) -> crate::errors::Result<(i64, i64, i64, i64, i64, i64, i64)> {
        let snapshot = self
            .session_database_for_test(scope)?
            .read_snapshot()
            .await
    ...
    pub async fn seed_lcm_render_fixture_for_test(
        ...
        let database = self.session_database_for_test(scope)?;
        let session = crate::sessions::SessionRecord {
        ...
        let external_hash = crate::sessions::lcm::util::sha256_hex(external_content.as_bytes());
    ...
    ) -> crate::errors::Result<LcmLineageCountsForTest> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    pub async fn lcm_raw_message_search_fields_for_test(
        ...
        provider: &str,
        message_id: &str,
    ) -> Result<Option<(String, String)>, crate::sessions::lcm::LcmError> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    pub async fn lcm_raw_message_fts_count_for_test(
        &self,
        query: &str,
    ) -> Result<i64, crate::sessions::lcm::LcmError> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    pub async fn lcm_raw_message_metadata_json_for_test(
        ...
        provider: &str,
        message_id: &str,
    ) -> Result<Option<Option<String>>, crate::sessions::lcm::LcmError> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    ) -> Result<crate::sessions::lcm::payload::DeleteOutcome, crate::sessions::lcm::LcmError> {
        let database = self
            .session_database_for_test(scope)
            .map_err(|error| crate::sessions::lcm::LcmError::Db(error.to_string()))?;
        let storage_root = database.db_path().parent().ok_or_else(|| {
    ...
    pub async fn lcm_external_payload_manifest_for_test(
        &self,
        payload_ref: &str,
    ) -> Result<Option<LcmExternalPayloadManifestTestRecord>, crate::sessions::lcm::LcmError> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    pub async fn lcm_summary_publication_receipt_id_for_test(
        &self,
        summary_id: &str,
    ) -> Result<Option<String>, crate::sessions::lcm::LcmError> {
        let snapshot = self
            .primary_session_database_for_test()
            .read_snapshot()
            .await
    ...
    pub async fn pending_codex_compaction_summary_requests_for_test(
        ...
        session_id: Option<&str>,
        limit: usize,
    ) -> Result<Vec<crate::global_db::PendingCodexCompactionSummary>, crate::sessions::lcm::LcmError>
    {
        self.primary_session_database_for_test()
        ...
        self.primary_session_database_for_test()
            ...
            .execute(
                "UPDATE lcm_raw_messages
                 SET metadata_json = ?1
                 WHERE store_id = ?2",
                crate::db::engine::params![metadata_json, store_id],
            )
            .await
            .map(|_| ())
            .map_err(|error| crate::errors::TraceDecayError::Database {
    ...
    #[doc(hidden)]
    pub async fn project_session_message_count_for_test(&self) -> crate::errors::Result<i64> {
        self.project_database_for_test()?
    ...
    ) -> crate::errors::Result<Vec<crate::sessions::git_correlation::SessionGitCorrelationHit>>
    {
        let snapshot = self
            .project_database_for_test()?
            .read_snapshot()
        ...
        crate::sessions::git_correlation::sessions_for(&snapshot, query)
            .await
            .map_err(|error| crate::errors::TraceDecayError::Database {
