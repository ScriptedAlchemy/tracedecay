...
mod tests {
    ...
    #[derive(Clone)]
    struct LegacyInventoryFixture(crate::semantic_code::legacy_migration::LegacyVectorInventoryV1);

    impl LegacyVectorInventoryPortV1 for LegacyInventoryFixture {
        fn read_only_inventory(
            &self,
        ) -> Result<
            crate::semantic_code::legacy_migration::LegacyVectorInventoryV1,
            LegacyVectorMigrationErrorV1,
        > {
            Ok(self.0.clone())
        }
