...
use tracedecay_domain::{
    ...
    MAX_WORK_PRODUCT_EVENT_RELATION_SCOPES, MAX_WORK_PRODUCT_EVENT_SOURCE_WATERMARKS, MilestoneId,
    ProjectionGenerationId, ProposalId, RetrievalAnchorId, RunId, SourceStoreId,
    TaskEvidenceLinkId, TaskEvidenceLinkV1, TaskId, UtcMicros, WorkAcceptanceCriterionV1,
    WorkAttemptIdentityV1, WorkAttemptStateV1, WorkGraphChangeV1, WorkGraphVersionV1,
    WorkHierarchyV1, WorkInitiativeV1, WorkItemInputV1, WorkItemV1, WorkPlanId, WorkPlanV1,
    WorkProductAuthorizedRelationScopeV1, WorkProductContractError, WorkProductEventContractError,
    WorkProductEventEvidenceV1, WorkProductEventInputV1, WorkProductEventPayloadV1,
    WorkProductEventSequenceV1, WorkProductEventV1, WorkProductGraphV1, WorkProductProfileScopeV1,
