//! Pure crash-safe framed-log primitives shared by hook and host-admission spools.
//!
//! Frame encoding and scan policy stay product-specific; this module holds only
//! deterministic checksum and append-intent evidence helpers.
