...
pub use code_intelligence::{
    ...
    Visibility, classify_technical_token, code_reused_partition_arc_share_digest,
    code_reused_partition_digest, code_reused_partition_digest_refs,
    code_source_parent_delta_digest, exact_search_canonical, generate_node_id, generate_node_id_at,
...
pub use configuration::{
    ...
    SYNC_WATCH_MAX_PROJECTS_SETTING_KEY, ScopeAccessRule,
...
pub use research::{
    ...
    NativeIntegrationSemanticConflictV1, NativeIntegrationTerminalOutcomeV1,
    ...
    WorktreeInventorySnapshotId, canonical_json_bytes, canonical_json_bytes_and_sha256,
    canonical_json_value, canonical_sha256, decode_with_canonical_digest,
    derive_exact_observation_anchor_id, derive_git_topology_anchor_id,
};
