...
use tracedecay_store::{
    ...
    SemanticVectorBatchOutputDigest, SemanticVectorBatchReceiptDigest, SemanticVectorBuildId,
    ...
    SemanticVectorGraphBatchDigest, SemanticVectorOutputDigest, SemanticVectorPlanDigest,
