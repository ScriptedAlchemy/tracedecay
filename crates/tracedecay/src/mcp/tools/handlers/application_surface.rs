...
mod tests {
    ...
    use tracedecay_contracts::{
        ...
        Deadline, RequestId, ResultContractRef, SafeDiagnostic, TemporalState,
    };
    use tracedecay_domain::{CodeGenerationId, UtcMicros};
    use tracedecay_tool_catalog::{BindingId, SchemaId};

    use super::{
        complete_protocol_controls, render_canonical_markdown, served_stale_code_graph_temporal,
    };
