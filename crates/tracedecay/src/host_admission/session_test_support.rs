...
impl HostAdmissionTestRuntimeV1 {
    ...
    pub async fn session_activity_for_test(
        &self,
        scope: HostAdmissionScope,
    ) -> tracedecay_runtime_core::errors::Result<tracedecay_agent_hosts::automation::scheduler::SessionActivity> {
        Ok(
    ...
    pub async fn ingest_project_provider_for_test(
        ...
        let authority = tracedecay_usecases::host_admission::session_ingest_authority::GlobalDbSessionIngestAuthority::new(database);
        Ok(
