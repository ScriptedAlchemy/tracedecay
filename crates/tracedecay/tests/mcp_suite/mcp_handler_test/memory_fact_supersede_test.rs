...
fn assert_problem(
    ...
    assert_eq!(
        result["structuredContent"]["problem"]["kind"], kind,
        "{result}"
    );
    assert_eq!(
        result["structuredContent"]["problem"]["code"], code,
        "{result}"
    );
    assert_eq!(
        result["structuredContent"]["problem"]["message"], message,
        "{result}"
    );
    assert_eq!(
        result["structuredContent"]["problem"]["retry"], retry,
        "{result}"
    );
    assert_eq!(
