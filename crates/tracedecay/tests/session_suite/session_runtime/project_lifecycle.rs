...
async fn register(
    ...
    service
        .register_project(DaemonSessionSyncConfig {
            ...
            project_root,
            transcript_source_profile: tracedecay_runtime_core::config::ProfileRoot::new(root.path().to_path_buf()),
    ...
    let mut registration = tokio::spawn(async move {
        registration_service
            .register_project(DaemonSessionSyncConfig {
                ...
                profile_id,
                project_id,
                transcript_source_profile: tracedecay_runtime_core::config::ProfileRoot::new(
                    &profile_root,
                ),
                profile_root,
                project_root,
