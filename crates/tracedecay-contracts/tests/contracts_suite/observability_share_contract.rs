...
fn aggregate_share_rejects_small_cohorts_and_dimension_overflow() {
    ...
    dimensions.dimensions = vec![
        ...
        AggregateShareDimensionV1::Outcome(tracedecay_contracts::AggregateOutcomeV1::Completed),
        AggregateShareDimensionV1::Os(tracedecay_contracts::AggregateOsFamilyV1::Linux),
