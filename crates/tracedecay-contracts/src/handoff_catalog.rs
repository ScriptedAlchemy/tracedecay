...
-> Result<ExecutableBindingRegistryV1, CatalogValidationError> {
    ExecutableBindingRegistryV1::new(vec![
        available::<IssueTaskHandoffRequestV1, IssueTaskHandoffResultV1>(
            ...
            "tracedecay_contracts::handoff::IssueTaskHandoffRequestV1",
            "tracedecay_contracts::handoff::IssueTaskHandoffResultV1",
        )?,
        available::<ListTaskHandoffsRequestV1, ListTaskHandoffsResultV1>(
            "list_task_handoffs",
            "/application/handoff/list-task",
            "tracedecay_contracts::handoff::ListTaskHandoffsRequestV1",
            "tracedecay_contracts::handoff::ListTaskHandoffsResultV1",
        )?,
        available::<OpenInvestigationHandoffRequestV1, OpenInvestigationHandoffResultV1>(
            "open_investigation_handoff",
            "/application/handoff/open-investigation",
            "tracedecay_contracts::handoff::OpenInvestigationHandoffRequestV1",
            "tracedecay_contracts::handoff::OpenInvestigationHandoffResultV1",
        )?,
        available::<OpenTaskHandoffRequestV1, OpenTaskHandoffResultV1>(
            "open_task_handoff",
            "/application/handoff/open-task",
            "tracedecay_contracts::handoff::OpenTaskHandoffRequestV1",
            "tracedecay_contracts::handoff::OpenTaskHandoffResultV1",
        )?,
    ])
}
