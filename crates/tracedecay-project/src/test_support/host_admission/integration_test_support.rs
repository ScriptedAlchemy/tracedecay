...
impl HostAdmissionTestRuntimeV1 {
    ...
    ) -> std::result::Result<Option<tracedecay_store::SourceCommitReceiptV1>, HostAdmissionOutcome>
    {
        ...
        let idempotency_key = tracedecay_contracts::request_identity::derive_logical_effect_idempotency(
            tracedecay_contracts::request_identity::LogicalEffectIdempotencyDomain::HostObservation,
