...
#[allow(clippy::unnecessary_wraps)]
fn default_session_message_days() -> Option<u32> {
    Some(DEFAULT_SESSION_MESSAGE_RETENTION_DAYS)
}
...
/// Local Hinnant `civil_from_days` so this crate stays free of workspace dependencies.
