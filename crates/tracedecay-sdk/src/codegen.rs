...
const HEADER: &str = concat!(
    "// Generated by `pnpm --dir dashboard run contracts:generate`. DO NOT EDIT.\n",
...
export type ApplicationProblemDetailV1 = { kind: "parked"; cause: string; remedy: string; retries_on_wake: boolean; [key: string]: unknown } | { kind: "stale_refresh_frontier"; requested: number; committed: number; active: number; [key: string]: unknown } | { kind: "lock_deadline"; resource: string; deadline_ms: number; [key: string]: unknown };
