...
pub(crate) async fn load_canonical_automation_config(
    project_path: &std::path::Path,
) -> tracedecay_runtime_core::errors::Result<tracedecay_automation_runtime::automation::config::AutomationConfig> {
...
fn automation_task_patch(
    ...
    task: &str,
) -> tracedecay_runtime_core::errors::Result<tracedecay_automation_runtime::automation::config::AutomationTaskPatch> {
    Ok(
...
fn parse_automation_backend(
    value: &str,
) -> tracedecay_runtime_core::errors::Result<tracedecay_automation_runtime::automation::config::AutomationBackend> {
...
fn parse_automation_host_mode(
    value: &str,
) -> tracedecay_runtime_core::errors::Result<tracedecay_automation_runtime::automation::config::AutomationHostMode> {
