...
#[hotpath::measure(label = "cli.dispatch.command", future = true)]
...
#[hotpath::measure(label = "cli.dispatch.project", future = true)]
...
#[hotpath::measure(label = "cli.dispatch.agent", future = true)]
...
#[hotpath::measure(label = "cli.dispatch.hook", future = true)]
