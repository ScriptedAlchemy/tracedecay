...
//! - **Direct reads of a lower owner.** [`mcp_tools`] names the crate that
//!   owns the data. It was never a root-only capability once the split
//!   settled, and inverting it cost real safety: an unregistered tool catalog
//!   answered empty, which installers wrote as a permission allowlist.
