...
fn append_embedded_file_constant(code: &mut String, constant: &str, path: &Path) {
...
fn main() {
    ...
    let mut dashboard_assets = String::from("// @generated by build.rs; do not edit.\n");
    for (constant, relative) in [
        ("HOLOGRAPHIC_JS", "dashboard/holographic/dist/index.js"),
        ("HOLOGRAPHIC_CSS", "dashboard/holographic/dist/style.css"),
        ("LCM_JS", "dashboard/lcm/dist/index.js"),
        ("LCM_CSS", "dashboard/lcm/dist/style.css"),
        ("GRAPH_JS", "dashboard/graph/dist/index.js"),
        ("GRAPH_CSS", "dashboard/graph/dist/style.css"),
        ("SAVINGS_JS", "dashboard/savings/dist/index.js"),
        ("SAVINGS_CSS", "dashboard/savings/dist/style.css"),
    ] {
        append_embedded_file_constant(&mut dashboard_assets, constant, &repository.join(relative));
    }
    fs::write(
        out_dir.join("hermes_dashboard_assets_generated.rs"),
        dashboard_assets,
    )
