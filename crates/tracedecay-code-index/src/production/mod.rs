...
pub trait CodeIndexAtomicPublicationPort {
    ...
    /// of this predecessor. Non-durable test and benchmark ports need no
    /// restart state; the daemon store overrides this method.
    ...
    /// Persist one complete physical artifact before generation publication.
    /// The predecessor namespace and physical reuse key make stale receipts
    /// ineligible without creating another incremental planning authority.
...
pub struct CodeIndexPublishedGenerationV1 {
    ...
    process_reextracted_files: usize,
}
...
impl CodeIndexPublishedGenerationV1 {
    pub fn process_reextracted_files(&self) -> usize {
        self.process_reextracted_files
    }
    ...
    S: CodeChunkProjectionSink,
{
    ...
    pub fn build_and_publish(
        ...
        let candidate = hotpath::measure_block!("code_index.build.assemble", {
            ...
            let candidate = CodeIndexPublishedGenerationV1 {
                ...
                process_reextracted_files: staged.process_reextracted_files,
            };
            hotpath::measure_block!(
    ...
    fn materialize_full(
        ...
        staged.process_reextracted_files = reextracted_files;
        Ok(staged)
    }
