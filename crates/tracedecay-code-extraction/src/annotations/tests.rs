use super::{AnnotationEmitterState, emit_annotation_usage, scan_children_for_annotation_kinds};
use crate::{JavaExtractor, KotlinExtractor, LanguageExtractor, ts_provider};
use tracedecay_domain::code_intelligence::{Edge, EdgeKind, Node, NodeKind, UnresolvedRef};
