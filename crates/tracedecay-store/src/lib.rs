...
pub use memory::{
    ...
    FactLineageCursor, FactLineageQuery, FactLineageResponseV1, FactQueryCoverageV1, FactStore,
    FactStoreError, FactStoreResult, FactWriteBatch, LegacyFactQuery,
    MAX_FACT_QUERY_CONTRADICTIONS, MAX_PROJECT_MEMORY_AUTOMATIC_FACT_RECEIPTS,
    MAX_PROJECT_MEMORY_GRAPH_RELATIONS, ProjectMemoryAutomaticFactApplyDispositionV1,
    ...
    ProjectMemoryFactProjectionV1, ProjectMemoryFactRelationV1, ProjectMemoryFactRemoveCommandV1,
    ...
    ProjectMemoryFactSearchPageV1, ProjectMemoryFactSearchQuery, ProjectMemoryFactSearchScoresV1,
    ProjectMemoryFactSourceV1, ProjectMemoryFactStatusV1, ProjectMemoryFactStore,
    ...
    ProjectMemoryFactUpdatePatchV1, ProjectMemoryFactV1, ProjectMemoryFeedbackRepairProgressV1,
    ProjectMemoryGraphPageV1, ProjectMemoryGraphQueryV1, ProjectMemoryGraphRelationKindV1,
    ProjectMemoryGraphRelationV1, ProjectMemoryGraphStore, ProjectMemoryGraphTargetV1,
    ProjectMemoryLegacyEntityTargetV1, ProjectMemoryMemoryAlgebraV1,
    ProjectMemoryMemoryFeedbackFunnelV1, ProjectMemoryMemoryRepairCommandV1,
    ProjectMemoryMemoryRepairStatsV1, ProjectMemoryMemoryStatusV1, ProjectMemoryProjectionStateV1,
    ProjectMemoryRelationProvenanceV1, ProjectMemoryResult, ProjectMemoryStoreError,
