...
pub use memory::{
    ...
    CompatibilityFeedbackRepairProgressV1, CompatibilityLegacyEntityTargetV1,
    ...
    FactAsOfResponseV1, FactCommitConflict, FactCommitOutcome, FactCommitReceipt,
    FactCompatibilityResult, FactCompatibilityStore, FactCompatibilityStoreError,
    FactContradictionStateV1, FactCurrentQuery, FactCurrentResponseV1, FactLineageCursor,
    FactLineageQuery, FactLineageResponseV1, FactProposalPromotionStateV1, FactProposalStore,
    FactProposalStoreError, FactQueryCoverageV1, FactStore, FactStoreError, FactStoreResult,
    FactWriteBatch, LegacyFactQuery, MAX_FACT_QUERY_CONTRADICTIONS,
