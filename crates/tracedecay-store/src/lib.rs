...
pub use memory::{
    ...
    ProjectMemoryRelationProvenanceV1, CurrentFactsQuery, FactAsOfQuery, FactAsOfResponseV1,
    FactCommitConflict, FactCommitOutcome, FactCommitReceipt, FactCompatibilityResult,
    FactCompatibilityStore, FactCompatibilityStoreError, FactContradictionStateV1,
    FactCurrentQuery, FactCurrentResponseV1, FactLineageCursor, FactLineageQuery,
    FactLineageResponseV1, FactProposalPromotionStateV1, FactProposalStore, FactProposalStoreError,
