...
use verified_read::{
    ...
    read_stable_payload_bytes_with,
};
pub(super) use verified_read::{
    read_verified_payload_text, read_verified_payload_text_with_checkpoint,
};
...
///
/// ```compile_fail
/// use tracedecay_lcm::payload::VerifiedPayloadAuthority;
///
