...
pub use crate::application::doctor_remediation::{
...
pub type DoctorRemediationDispatcherV1 = DoctorRemediationAuthorityV1;
pub type DoctorRemediationPreviewRequestV1 =
