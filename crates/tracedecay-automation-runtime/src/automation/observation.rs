//! Ledger-to-funnel observation mapping for automation runs.
//!
//! Recording stays in the composition root: root passes an already-resolved
//! observer. This module only classifies exact ledger evidence.
...
pub fn automation_funnel_observation_from_record(
