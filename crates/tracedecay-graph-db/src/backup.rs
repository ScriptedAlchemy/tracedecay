...
pub(crate) fn create_full(
    ...
    let result = create_staged_full(database, expected_format, &staging);
...
fn create_staged_full(
    ...
    let manifest = GraphBackupManifest {
        ...
        graph_format_version: expected_format.get(),
        target_epoch,
        artifacts,
    };
...
fn restore_to_staging(
    ...
    let restored = GraphDb::open(GraphDbOpenOptions {
        location: GraphDbLocation::Persistent(staging.to_path_buf()),
        expected_format,
