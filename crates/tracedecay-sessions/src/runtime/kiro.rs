...
impl KiroSource {
    ...
    pub fn with_home(home: &Path) -> Self {
        let data_dir = super::kiro_data_dir(home);
        Self {
...
pub async fn ingest_kiro_for_project<S>(
    db: &S,
    project_root: &Path,
    ...
    S: TranscriptIngestStore,
{
    ...
    crate::runtime::source::ingest_source(db, &source, project_root, max_new_bytes).await
}
