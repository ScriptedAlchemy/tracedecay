...
impl ObservationProjectionStore for GlobalDbObservationStore<'_> {
    ...
    async fn project_observation(
        ...
        tracedecay_global_db::project_observation_with_engine(&connection, observation_id).await
    }
    ...
    async fn rebuild_projection(
        ...
        let connection = tracedecay_runtime_core::db::engine::Connection::attach(handle);
        tracedecay_global_db::rebuild_projection_with_engine(&connection, frontier_sequence).await
    }
}
