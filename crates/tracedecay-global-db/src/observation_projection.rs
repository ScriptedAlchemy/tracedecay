...
pub use rebuild::{converge_projection_predecessor, project_observation, rebuild_projection};
#[cfg(test)]
...
pub(super) use state::{
    ...
    read_projection_rows_batch, resolve_output_projection, verify_projection_rows,
