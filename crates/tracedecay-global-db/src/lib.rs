...
pub use schema::ensure_registered_schema;
...
pub use registered::{
    RegisteredGlobalDb, RegisteredGlobalDbWriteTransaction, SessionGitGraphPublicationWake,
};
pub use registry_retention::{
    RegistryGcReport, RootLivenessV1, StaleRootScope, apply_registry_gc, code_project_root_exists,
    code_project_root_liveness, probe_root, project_context_liveness, registry_gc_report,
    stale_code_projects, stale_project_contexts,
};
