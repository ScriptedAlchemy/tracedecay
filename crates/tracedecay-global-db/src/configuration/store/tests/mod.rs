...
use super::canonical::validate_final_snapshot;
...
#[test]
fn incomplete_snapshot_requires_reset() {
    ...
    assert_eq!(
        validate_final_snapshot(&incomplete),
        Err(super::ConfigurationError::ResetRequired)
    );
}
...
fn root_revision() -> ConfigurationRevisionRecordV1 {
    ...
    ConfigurationRevisionRecordV1 {
        ...
        operation_kind: "genesis".to_owned(),
