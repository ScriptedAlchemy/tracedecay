...
/// that did happen as work that did not.
///
...
/// the *calling thread's* dispatcher. Constructing them also rebuilds the
/// interest cache, repairing any callsite already poisoned before the first
/// census ran.
///
