...
pub use retrieval::{
    ...
    CallableCodeAuthorizationFuture, CallableCodeAuthorizationPort, CallableCodeOperationAdmission,
    ...
    ExactOccurrenceRequest, GraphCallersRequest, GraphImpactRequest, GraphImpactResult,
    ...
    TemporalRetrievalPort, TestRetrievalPort, UNPINNED_LATEST_GENERATION_SENTINEL,
