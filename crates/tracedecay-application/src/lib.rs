...
pub use retrieval::{
    AffectedTestAttributionV1, AffectedTestsRequest, AffectedTestsRetrievalPort,
    AffectedTestsService, AnchorExpandRequest, AnchorExpandResult, AnchorHydrationPort,
    ...
    GraphCallersRequest, GraphCallersService, GraphImpactRequest, GraphImpactResult,
    GraphImpactRetrievalPort, GraphRetrievalPort, HealthDeltaCoverageV1,
    HealthDeltaCurrentnessV1, HealthDeltaPointV1, HealthDeltaRequest, HealthDeltaResult,
    HealthDeltaScopeV1, HealthDimensionDeltaV1, HealthDimensionPointV1, HealthReadRequest,
    ...
    SourceLinesResult, SourceLinesService, SourceMetadataRecord, SourceMetadataRequest,
    SourceRetrievalPort, SymbolRetrievalPort, SymbolSearchRequest, SymbolSearchResult,
    SymbolSearchService, TemporalRetrievalPort, TestRetrievalPort,
