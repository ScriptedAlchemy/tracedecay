    ...
    fn expand<'a>(
        ...
        Box::pin(hotpath::future!(
            async move {
                ...
                let expanded = tracedecay_contracts::AnchorExpandResult {
                ...
                store_request_handle(
                    ...
                    request_record(
                        ...
                        FeedbackReadRequestV1::Expand(FeedbackExpandRequestV1 {
                            finding_id: finding.finding_id.clone(),
                            expansion: tracedecay_contracts::AnchorExpandRequest {
                                anchor: anchor.clone(),
...
mod tests {
    use super::*;
    use tracedecay_contracts::{CancellationContext, CapabilityGrantSnapshot, Deadline, RequestId};
    ...
    fn source_envelope(boot_id: &ManifestDigest, sequence: u64) -> FeedbackObservationEnvelopeV1 {
        super::super::observations::feedback_source_event_envelope_for_subject(
            ...
            FeedbackSourceEventV1::ArgumentRejected {
                operation:
                    tracedecay_contracts::feedback::observations::FeedbackOperationV1::FeedbackGet,
