...
fn daemon_request_context(
    ...
    for (capability_id, use_case_id) in [
        ...
        (
            ...
            tracedecay_contracts::feedback::CI_FAILURE_LOCALIZE_USE_CASE_ID_V1,
        ),
        (
            tracedecay_contracts::feedback::PROXIMITY_CAPABILITY_ID_V1,
            tracedecay_contracts::feedback::PROXIMITY_USE_CASE_ID_V1,
        ),
    ] {
...
mod tests {
    ...
    use super::*;
    use tracedecay_contracts::diagnostics::AnalyzerAdmittedDiagnosticProviderV1;
    use tracedecay_contracts::policy::PolicyEvaluatorCompositionV1;
    use tracedecay_domain::configuration::{
    ...
    fn missing_mounted_provider_contributes_typed_unavailable() {
        ...
        assert_eq!(
            admitted.state(),
            tracedecay_contracts::diagnostics::DiagnosticProviderState::Unavailable
        );
    }
}
