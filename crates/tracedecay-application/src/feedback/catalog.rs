...
const FEEDBACK_SPECS: [FeedbackSurfaceSpec; 10] = [
    ...
    FeedbackSurfaceSpec {
        ...
        description: "Resolve changed files through the canonical test-attribution primitive with preserved coverage and continuation.",
        example: "Find tests affected by these files",
        paginated: true,
        surfaces: &PR12_TRANSPORT_SURFACES,
    },
    FeedbackSurfaceSpec {
