//! Crash-safe local framed-log I/O primitives.
//!
//! These helpers make append/rename/metadata publishes durable without owning
//! spool policy, transport, SQL, or daemon authority.
