use tracedecay_contracts::{ObservabilityHorizonV1, ObservabilityRecordPort, now_micros};
...
fn metric_value(model: &tracedecay_contracts::ObservatoryReadModelV1, name: &str) -> f64 {
    model
        .metrics
        .iter()
...
async fn canonical_read_selects_latest_consent_and_keeps_unrecorded_evidence_unknown() {
    ...
    assert_eq!(
        ...
        tracedecay_contracts::ComparisonDispositionV1::InsufficientEvidence
    );
