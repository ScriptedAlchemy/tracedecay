...
use tracedecay_contracts::{WorkLeakAdjudicationReceiptV1, WorkRetryReceiptV1};
...
mod tests {
    ...
    fn retry_receipt(evidence_ref: &str) -> WorkRetryReceiptV1 {
        let command = RetryWorkAttemptCommandV1 {
            ...
            failure: tracedecay_contracts::WorkRetryFailureSelectorV1 {
                source: tracedecay_contracts::WorkRetrySourceV1::Runtime,
                cause: tracedecay_contracts::WorkRetryCauseV1::RuntimeFailure,
