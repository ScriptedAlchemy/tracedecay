...
use tracedecay_application::{
    ...
    ProfileAuthorityReadV1, RequestContext, RuntimeHealthDoctorPort, RuntimeHealthReadV1,
...
#[test]
fn doctor_report_exposes_profile_authority_truth_without_replacing_runtime_health() {
    let ctx = context();
    let runtime = StaticRuntime(RuntimeHealthReadV1::Observed {
        liveness: RuntimeLivenessV1::Healthy,
        coverage: DoctorCoverageCompletenessV1::Complete,
