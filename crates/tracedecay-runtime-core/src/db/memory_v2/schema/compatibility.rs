//! Final compatibility projection, fact-relation, and holographic-bank schema.

use crate::errors::Result;

use super::super::{MemoryV2Executor, db_error};

pub(super) async fn install_compatibility_schema(
...
pub(super) async fn install_compatibility_bank_schema(
    conn: &impl MemoryV2Executor,
    operation: &str,
) -> Result<()> {
    conn.execute_batch(
