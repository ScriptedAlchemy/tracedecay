...
//! `application::context`, but kernel store runtimes use them to bound work,
//! so they moved down with the store-runtime boundary. The root re-exports
//! both from their historical path.
