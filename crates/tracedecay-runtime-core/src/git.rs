...
//!
//! The topology reads in [`crate::branch`] and [`crate::worktree`] are fully
//! in-process. This module owns the bounded CLI fallback used where exact
//! porcelain semantics remain the authority.
