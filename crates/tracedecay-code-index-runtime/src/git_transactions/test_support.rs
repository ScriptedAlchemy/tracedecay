...
pub type TestPort = DaemonGitIndexTransactionPort<
...
pub struct TestHarness {
    pub _database: RegisteredGlobalDbHarness,
    pub port: TestPort,
    pub preview: GitIndexPreviewV1,
    pub request: GitIndexApplyRequestV1,
    pub apply_calls: Arc<AtomicUsize>,
    pub recovery_calls: Arc<AtomicUsize>,
    pub entered_native: Arc<AtomicBool>,
    pub allow: Arc<std::sync::atomic::AtomicBool>,
    pub policy_calls: Arc<AtomicUsize>,
    pub policy_evaluated_at: Arc<Mutex<Option<UtcMicros>>>,
}
...
pub struct TestPolicy {
    ...
    pub evaluated_at: Arc<Mutex<Option<UtcMicros>>>,
}
...
pub fn snapshot() -> RepositoryStateSnapshotV1 {
...
pub fn fixture_time(ordinal: i64) -> UtcMicros {
...
pub fn preview() -> GitIndexPreviewV1 {
...
pub fn apply_request(preview: &GitIndexPreviewV1, key: &str) -> GitIndexApplyRequestV1 {
    let binding =
...
pub fn test_store() -> (RegisteredGlobalDbHarness, DaemonGitIndexTransactionStore) {
