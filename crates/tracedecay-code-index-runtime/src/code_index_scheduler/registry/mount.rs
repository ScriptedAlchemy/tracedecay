...
use super::{
    ...
    convergence_park_is_terminal_publication_authority, convergence_park_retries_on_wake,
    is_repeated_conflict_verdict, park_convergence, retained_noop_requires_follow_up_wake,
};
    ...
    async fn mount_worktree_inner(
        ...
        let worker_loop = Box::pin(async move {
            ...
            loop {
                ...
                if convergence_park_is_terminal_publication_authority(&worker_convergence_park) {
