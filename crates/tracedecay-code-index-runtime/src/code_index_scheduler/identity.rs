...
impl IndexingIdentityV1 {
    ...
    pub fn head_ref(&self) -> Option<&RefId> {
    ...
    pub fn authorizes_reuse_of(&self, prior: &IndexingIdentityV1) -> bool {
    ...
    #[cfg(test)]
    pub fn same_source_revision(&self, other: &IndexingIdentityV1) -> bool {
...
pub struct GitMetadataFingerprintV1 {
...
impl GitMetadataFingerprintV1 {
    ...
    pub fn differs_from(&self, other: &GitMetadataFingerprintV1) -> bool {
        self != other
    }
...
pub fn repository_id_for(project_root: &Path) -> Result<RepositoryId, IdentityErrorV1> {
