...
pub enum CodeIndexCadenceTriggerV1 {
...
pub enum CodeIndexCadenceOutcomeV1 {
    Published {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct CodeIndexEventToReadyReceiptV1 {
...
impl CodeIndexEventToReadyReceiptV1 {
    ...
    pub fn queue_delay_micros(&self) -> Option<i64> {
        self.arrival
            .wake_micros()
    ...
    pub fn service_micros(&self) -> i64 {
    ...
    pub fn event_to_ready_micros(&self) -> Option<i64> {
        self.arrival
            .wake_micros()
...
pub const P50_MINIMUM_SAMPLES: usize = 2;
pub const P95_MINIMUM_SAMPLES: usize = 40;
pub const P99_MINIMUM_SAMPLES: usize = 100;

/// One percentile and the sample floor it requires.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct CodeIndexPercentileV1 {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct CodeIndexPercentilesV1 {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct CodeIndexCadenceReadModelV1 {
...
impl CodeIndexCadenceTelemetryV1 {
    ...
    #[cfg(test)]
    pub fn latest(&self) -> Option<&CodeIndexEventToReadyReceiptV1> {
        self.receipts.back()
    }
    ...
    pub fn read_model(&self) -> CodeIndexCadenceReadModelV1 {
...
pub fn newly_eligible_percentile(latency_sample_count: usize) -> Option<&'static str> {
