...
impl CodeChunkProjectionSink for DaemonProjectionSinkV1 {
    fn project_changed_chunks(
        ...
        // Unchanged chunks are not a list. `reused_count` and `reused_digest`
        // on the request authenticate that complement; the receipt builder
        // copies the count. Emitting a row per reused chunk would invent
        // identities the type does not carry.
