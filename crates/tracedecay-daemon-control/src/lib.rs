...
pub use service::{
    DaemonProcessProofV1, DaemonServiceSpec, DaemonServiceState, MaintenanceWindowOutcome,
    QuiescedDaemonLifecycle, daemon_reachable, daemon_socket_connectable, default_socket_path,
    install_service, install_service_under_lease, installed_service_process_proof,
