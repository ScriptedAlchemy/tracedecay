...
export const CurationEventSchema = z
  .object({
    ts: z.string(),
    phase: z.string(),
    message: z.string(),
...
/** `GET /curation/activity` (`memory_service::curation_activity_payload`). */
export const CurationActivityPayloadSchema = z
  .object({
    events: z.array(CurationEventSchema),
    count: z.number(),
    limit: z.number(),
    error: z.string(),
  })
