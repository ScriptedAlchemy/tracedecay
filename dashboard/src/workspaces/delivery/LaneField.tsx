...
export function LaneField({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-2">
      ...
      <div className="td-optic td-grain relative flex min-h-72 flex-1 flex-col" data-field="delivery-lanes">
        <Corners tone="signal" />
        ...
        {/* Its own row under the scroll box, which the layout is measured
          * from, so the readout never covers the last lane. */}
        <p
          aria-live="polite"
          className={cn(
            'relative z-[2] border-t border-edge-subtle px-3 py-1.5 text-3xs text-text-secondary',
      ...
      <div className="space-y-1">
        ...
        />
        <ul aria-label="Field legend" className="flex flex-wrap gap-x-4 gap-y-1 text-3xs text-text-muted">
        ...
        <p className="flex flex-wrap items-center gap-2 text-3xs text-text-muted">
