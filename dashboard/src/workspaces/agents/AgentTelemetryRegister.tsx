...
export function AgentTelemetryRegister({
  usagePending,
  usageResult,
  diagnostics,
  underused,
  ...
  usageResult: EnvelopeResult<AnalyticsUsageSummaryV1> | undefined;
  diagnostics: UseQueryResult<EnvelopeResult<AnalyticsDiagnosticsPayloadV1>>;
  underused: UseQueryResult<EnvelopeResult<AnalyticsUnderusedPayloadV1>>;
}) {
  return (
