/**
 * The same symbols the anatomy plate draws, as text, in call-site order.
 *
 * This is not a summary of the picture, it is the picture's exact contents.
 * Anything the plate encodes as a column, a bar length or a connector is
 * printed here as a number, so a screen reader can read the whole
 * neighbourhood as one ranked list rather than walking the plate's controls.
 * A component that has to stay symbol-for-symbol identical to another one is
