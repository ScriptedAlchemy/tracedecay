...
export const settingsButtonClass =
  'inline-flex min-h-[var(--touch-target-min)] items-center justify-center rounded-[var(--radius-standard)] border border-accent/50 bg-accent/15 px-3 text-body font-semibold text-text-primary hover:border-accent disabled:cursor-not-allowed disabled:opacity-50';

export const secondarySettingsButtonClass =
  'inline-flex min-h-[var(--touch-target-min)] items-center justify-center rounded-[var(--radius-standard)] border border-edge-subtle bg-surface-2 px-3 text-body font-medium text-text-secondary hover:text-text-primary';
...
export const settingsCheckboxRowClass =
  'flex min-h-[calc(var(--touch-target-min)+2px)] w-full cursor-pointer items-center rounded-[var(--radius-chip)] border border-edge-subtle bg-surface-0 text-body text-text-secondary hover:text-text-primary';
