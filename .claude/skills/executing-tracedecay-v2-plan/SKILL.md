...
```bash
python3 .claude/skills/executing-tracedecay-v2-plan/scripts/plan_inventory.py
```
...
```bash
python3 .claude/skills/executing-tracedecay-v2-plan/scripts/plan_execution.py \
